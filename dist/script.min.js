! function(e, t) {
    ...
    function o() {
        Z.removeEventListener("DOMContentLoaded", o), e.removeEventListener("load", o), se.ready()
    }
    ...
    function u(e, t, n, i) {
        var r, s = 1,
            ...
            c = (se.cssNumber[t] || "px" !== u && +l) && Pe.exec(se.css(e, t));
        if (c && c[3] !== u) {
            u = u || c[3], n = n || [], c = +l || 1;
            do s = s || ".5", c /= s, se.style(e, t, c + u); while (s !== (s = a() / l) && 1 !== s && --o)
        }
    ...
    function p(e, t, n, i, r) {
        for (var s, o, a, l, u, p, h = t.createDocumentFragment(), f = [], g = 0, m = e.length; g < m; g++)
            if (s = e[g], s || 0 === s)
                if ("object" === se.type(s)) se.merge(f, s.nodeType ? [s] : s);
                else if (Le.test(s)) {
            for (o = o || h.appendChild(t.createElement("div")), a = (Ne.exec(s) || ["", ""])[1].toLowerCase(), l = Ie[a] || Ie._default, o.innerHTML = l[1] + se.htmlPrefilter(s) + l[2], p = l[0]; p--;) o = o.lastChild;
            se.merge(f, o.childNodes), o = h.firstChild, o.textContent = ""
        } else f.push(t.createTextNode(s));
        for (h.textContent = "", g = 0; s = f[g++];)
            if (i && se.inArray(s, i) > -1) r && r.push(s);
            else if (u = se.contains(s.ownerDocument, s), o = c(h.appendChild(s), "script"), u && d(o), n)
            for (p = 0; s = o[p++];) Me.test(s.type || "") && n.push(s);
        return h
    }
    ...
    function w(e, t) {
        var n, i, r, s, o, a, l, u;
        if (1 === t.nodeType) {
            if (Se.hasData(e) && (s = Se.access(e), o = Se.set(t, s), u = s.events)) {
                delete o.handle, o.events = {};
                for (r in u)
                    for (n = 0, i = u[r].length; n < i; n++) se.event.add(t, r, u[r][n])
            }
            ke.hasData(e) && (a = ke.access(e), l = se.extend({}, a), ke.set(t, l))
        }
    }
    ...
    function C(e, t, n, i) {
        ...
        var r, s, o, a, l, u, d = 0,
            ...
            g = t[0],
            m = se.isFunction(g);
        if (m || h > 1 && "string" == typeof g && !ie.checkClone && Re.test(g)) return e.each(function(r) {
            var s = e.eq(r);
            m && (t[0] = g.call(this, r, s.html())), C(s, t, n, i)
        });
        if (h && (r = p(t, e[0].ownerDocument, !1, e, i), s = r.firstChild, 1 === r.childNodes.length && (r = s), s || i)) {
            for (o = se.map(c(r, "script"), y), a = o.length; d < h; d++) l = r, d !== f && (l = se.clone(l, !0, !0), a && se.merge(o, c(l, "script"))), n.call(e[d], l, d);
            if (a)
                for (u = o[o.length - 1].ownerDocument, se.map(o, b), d = 0; d < a; d++) l = o[d], Me.test(l.type || "") && !Se.access(l, "globalEval") && se.contains(u, l) && (l.src ? se._evalUrl && se._evalUrl(l.src) : se.globalEval(l.textContent.replace(Be, "")))
        }
        return e
    }

    function T(e, t, n) {
        for (var i, r = t ? se.filter(t, e) : e, s = 0; null != (i = r[s]); s++) n || 1 !== i.nodeType || se.cleanData(c(i)), i.parentNode && (n && se.contains(i.ownerDocument, i) && d(c(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    ...
    function S(e) {
        var t = Z,
            n = Xe[e];
        return n || (n = _(e, t), "none" !== n && n || (Ye = (Ye || se("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ye[0].contentDocument, t.write(), t.close(), n = _(e, t), Ye.detach()), Xe[e] = n), n
    }

    function k(e, t, n) {
        var i, r, s, o, a = e.style;
        return n = n || Qe(e), o = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== o && void 0 !== o || se.contains(e.ownerDocument, e) || (o = se.style(e, t)), n && !ie.pixelMarginRight() && Ze.test(o) && We.test(t) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s), void 0 !== o ? o + "" : o
    }
    ...
    function P(e, t, n, i, r) {
        for (var s = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; s < 4; s += 2) "margin" === n && (o += se.css(e, n + De[s], !0, r)), i ? ("content" === n && (o -= se.css(e, "padding" + De[s], !0, r)), "margin" !== n && (o -= se.css(e, "border" + De[s] + "Width", !0, r))) : (o += se.css(e, "padding" + De[s], !0, r), "padding" !== n && (o += se.css(e, "border" + De[s] + "Width", !0, r)));
        return o
    }
    ...
    function D(t, n, i) {
        var r = !0,
            ...
            o = Qe(t),
            a = "border-box" === se.css(t, "boxSizing", !1, o);
        if (Z.msFullscreenElement && e.top !== e && t.getClientRects().length && (s = Math.round(100 * t.getBoundingClientRect()[n])), s <= 0 || null == s) {
            if (s = k(t, n, o), (s < 0 || null == s) && (s = t.style[n]), Ze.test(s)) return s;
            r = a && (ie.boxSizingReliable() || s === t.style[n]), s = parseFloat(s) || 0
        }
        return s + P(t, n, i || (a ? "border" : "content"), r, o) + "px"
    }

    function F(e, t) {
        for (var n, i, r, s = [], o = 0, a = e.length; o < a; o++) i = e[o], i.style && (s[o] = Se.get(i, "olddisplay"), n = i.style.display, t ? (s[o] || "none" !== n || (i.style.display = ""), "" === i.style.display && Fe(i) && (s[o] = Se.access(i, "olddisplay", S(i.nodeName)))) : (r = Fe(i), "none" === n && r || Se.set(i, "olddisplay", r ? n : se.css(i, "display"))));
    ...
    function L(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = se.css(e, "display"), c = "none" === u ? Se.get(e, "olddisplay") || S(e.nodeName) : u, "inline" === c && "none" === se.css(e, "float") && (h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always(function() {
        ...
        if (se.isEmptyObject(p)) "inline" === ("none" === u ? S(e.nodeName) : u) && (h.display = u);
        else {
            g ? "hidden" in g && (f = g.hidden) : g = Se.access(e, "fxshow", {}), s && (g.hidden = !f), f ? se(e).show() : d.done(function() {
                se(e).hide()
            }), d.done(function() {
                var t;
                Se.remove(e, "fxshow");
    ...
    function V(e, t) {
        var n, i, r, s, o;
        for (n in e)
            if (i = se.camelCase(n), r = t[i], s = e[n], se.isArray(s) && (r = s[1], s = e[n] = s[0]), n !== i && (e[i] = s, delete e[n]), o = se.cssHooks[i], o && "expand" in o) {
    ...
    function $(e, t, n) {
        var i, r, s = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = rt || N(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, s = 1 - i, o = 0, l = u.tweens.length; o < l; o++) u.tweens[o].run(s);
            ...
            c = u.props;
        for (V(c, u.opts.specialEasing); s < o; s++)
            if (i = $.prefilters[s].call(u, e, c, u.opts)) return se.isFunction(i.stop) && (se._queueHooks(u.elem, u.opts.queue).stop = se.proxy(i.stop, i)), i;
        return se.map(c, I, u), se.isFunction(u.opts.start) && u.opts.start.call(e, u), se.fx.timer(se.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    function Y(e, t, n, i) {
        var r;
        if (se.isArray(t)) se.each(t, function(t, r) {
            n || Pt.test(e) ? i(e, r) : Y(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    se.fn = se.prototype = {
        ...
        var e, t, n, i, r, s, o = arguments[0] || {},
            ...
            l = arguments.length,
            u = !1;
        for ("boolean" == typeof o && (u = o, o = arguments[a] || {}, a++), "object" == typeof o || se.isFunction(o) || (o = {}), a === l && (o = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = o[t], i = e[t], o !== i && (u && i && (se.isPlainObject(i) || (r = se.isArray(i))) ? (r ? (r = !1, s = n && se.isArray(n) ? n : []) : s = n && se.isPlainObject(n) ? n : {}, o[t] = se.extend(u, s, i)) : void 0 !== i && (o[t] = i));
        return o
    }, se.extend({
        ...
        globalEval: function(e) {
            var t, n = eval;
            e = se.trim(e), e && (1 === e.indexOf("use strict") ? (t = Z.createElement("script"), t.text = e, Z.head.appendChild(t).parentNode.removeChild(t)) : n(e))
        },
        ...
        grep: function(e, t, n) {
            for (var i, r = [], s = 0, o = e.length, a = !n; s < o; s++) i = !t(e[s], s), i !== a && r.push(e[s]);
            return r
        },
        map: function(e, t, i) {
            var r, s, o = 0,
                a = [];
            if (n(e))
                for (r = e.length; o < r; o++) s = t(e[o], o, i), null != s && a.push(s);
            else
        ...
        proxy: function(e, t) {
            var n, i, r;
            if ("string" == typeof t && (n = e[t], t = e, e = n), se.isFunction(e)) return i = Q.call(arguments, 2), r = function() {
                return e.apply(t || this, i.concat(Q.call(arguments)))
            }, r.guid = e.guid = e.guid || se.guid++, r
        },
        now: Date.now,
        support: ie
    }), "function" == typeof Symbol && (se.fn[Symbol.iterator] = W[Symbol.iterator]), se.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(e, t) {
        ee["[object " + t + "]"] = t.toLowerCase()
    });
    var ce = function(e) {
        function t(e, t, n, i) {
            var r, s, o, a, l, u, d, h, f = t && t.ownerDocument,
                g = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== g && 9 !== g && 11 !== g) return n;
            if (!i && ((t ? t.ownerDocument || t : H) !== F && D(t), t = t || F, N)) {
                if (11 !== g && (u = ve.exec(e)))
                    if (r = u[1]) {
                        if (9 === g) {
                            if (!(o = t.getElementById(r))) return n;
                            if (o.id === r) return n.push(o), n
                        } else if (f && (o = f.getElementById(r)) && V(t, o) && o.id === r) return n.push(o), n
                    } else {
                        if (u[2]) return K.apply(n, t.getElementsByTagName(e)), n;
                        if ((r = u[3]) && x.getElementsByClassName && t.getElementsByClassName) return K.apply(n, t.getElementsByClassName(r)), n
                    } if (x.qsa && !B[e + " "] && (!M || !M.test(e))) {
                    if (1 !== g) f = t, h = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") : t.setAttribute("id", a = $), d = S(e), s = d.length, l = pe.test(a) ? "#" + a : "[id='" + a + "']"; s--;) d[s] = l + " " + p(d[s]);
        ...
        function h(e, t, n) {
            ...
            return t.first ? function(t, n, s) {
                ...
                if (o) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || r) {
                            if (u = t[$] || (t[$] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (a = l[i]) && a[0] === q && a[1] === s) return c[2] = a[2];
        ...
        function v(e, t, n, r, s, o) {
            return r && !r[$] && (r = v(r)), s && !s[$] && (s = v(s, o)), i(function(i, o, a, l) {
                var u, c, d, p = [],
                    h = [],
                    f = o.length,
                    ...
                    b = n ? s || (i ? e : f || r) ? [] : o : y;
                if (n && n(y, b, a, l), r)
                    for (u = m(b, h), r(u, [], a, l), c = u.length; c--;)(d = u[c]) && (b[h[c]] = !(y[h[c]] = d));
                if (i) {
                    if (s || e) {
                        if (s) {
                        ...
                        for (c = b.length; c--;)(d = b[c]) && (u = s ? ee(i, d) : p[c]) > -1 && (i[u] = !(o[u] = d))
                    }
                } else b = m(b === o ? b.splice(f, b.length) : b), s ? s(null, o, b, l) : K.apply(o, b)
            })
        }

        function y(e) {
            for (var t, n, i, r = e.length, s = C.relative[e[0].type], o = s || C.relative[" "], a = s ? 1 : 0, l = h(function(e) {
                    return e === t
                }, o, !0), u = h(function(e) {
                    return ee(t, e) > -1
                }, o, !0), c = [function(e, n, i) {
                    var r = !s && (i || n !== A) || ((t = n).nodeType ? l(e, n, i) : u(e, n, i));
                    return t = null, r
                }]; a < r; a++)
                if (n = C.relative[e[a].type]) c = [h(f(c), n)];
                else {
            ...
            var r = n.length > 0,
                ...
                o = function(i, o, a, l, u) {
                    var c, d, p, h = 0,
                        ...
                        x = b.length;
                    for (u && (A = o === F || o || u); f !== x && null != (c = b[f]); f++) {
                        if (s && c) {
                            for (d = 0, o || c.ownerDocument === F || (D(c), a = !N); p = e[d++];)
                                if (p(c, o || F, a)) {
                                    l.push(c);
                                    break
                                } u && (q = w)
        ...
        var w, x, C, T, _, S, k, E, A, O, P, D, F, j, N, M, I, L, V, $ = "sizzle" + 1 * new Date,
            H = e.document,
            q = 0,
            U = 0,
            R = n(),
        ...
        try {
            K.apply(Z = J.call(H.childNodes), H.childNodes), Z[H.childNodes.length].nodeType
        } catch (Te) {
            K = {
        ...
        x = t.support = {}, _ = t.isXML = function(e) {
            ...
            return i !== F && 9 === i.nodeType && i.documentElement ? (F = i, j = F.documentElement, N = !_(F), (n = F.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), x.attributes = r(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = r(function(e) {
                return e.appendChild(F.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = me.test(F.getElementsByClassName), x.getById = r(function(e) {
                return j.appendChild(e).id = $, !F.getElementsByName || !F.getElementsByName($).length
            ...
            })), (x.matchesSelector = me.test(L = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && r(function(e) {
                x.disconnectedMatch = L.call(e, "div"), L.call(e, "[s!='']:x"), I.push("!=", se)
            }), M = M.length && new RegExp(M.join("|")), I = I.length && new RegExp(I.join("|")), t = me.test(j.compareDocumentPosition), V = t || me.test(j.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === F || e.ownerDocument === H && V(H, e) ? -1 : t === F || t.ownerDocument === H && V(H, t) ? 1 : O ? ee(O, e) - ee(O, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return P = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    a = [e],
                    l = [t];
                if (!r || !s) return e === F ? -1 : t === F ? 1 : r ? -1 : s ? 1 : O ? ee(O, e) - ee(O, t) : 0;
                if (r === s) return o(e, t);
            ...
            if ((e.ownerDocument || e) !== F && D(e), n = n.replace(ce, "='$1']"), x.matchesSelector && N && !B[n + " "] && (!I || !I.test(n)) && (!M || !M.test(n))) try {
                var i = L.call(e, n);
            ...
            var n = C.attrHandle[t.toLowerCase()],
                i = n && W.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !N) : void 0;
            ...
            var t, n = [],
                i = 0,
                r = 0;
            if (P = !x.detectDuplicates, O = !x.sortStable && e.slice(0), e.sort(Y), P) {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, r) {
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        var u, c, d, p, h, f, g = s !== o ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (f = [o ? m.firstChild : m.lastChild], o && y) {
                                for (p = m, d = p[$] || (p[$] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], h = u[0] === q && u[1], b = h && u[2], p = h && m.childNodes[h]; p = ++h && p && p[g] || (b = h = 0) || f.pop();)
                                    if (1 === p.nodeType && ++b && p === t) {
                                        c[e] = [q, h, b];
                                        break
                                    }
                            } else if (y && (p = t, d = p[$] || (p[$] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), u = c[e] || [], h = u[0] === q && u[1], b = h), b === !1)
                                for (;
                                    (p = ++h && p && p[g] || (b = h = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (d = p[$] || (p[$] = {}), c = d[p.uniqueID] || (d[p.uniqueID] = {}), c[e] = [q, b]), p !== t)););
        ...
        return d.prototype = C.filters = C.pseudos, C.setFilters = new d, S = t.tokenize = function(e, n) {
            var i, r, s, o, a, l, u, c = z[e + " "];
            if (c) return n ? 0 : c.slice(0);
            for (a = e, l = [], u = C.preFilter; a;) {
                i && !(r = le.exec(a)) || (r && (a = a.slice(r[0].length) || a), l.push(s = [])), i = !1, (r = ue.exec(a)) && (i = r.shift(), s.push({
                    value: i,
                    type: r[0].replace(ae, " ")
                }), a = a.slice(i.length));
                for (o in C.filter) !(r = he[o].exec(a)) || u[o] && !(r = u[o](r)) || (i = r.shift(), s.push({
                    value: i,
                    type: o,
                    matches: r
                }), a = a.slice(i.length));
            ...
            var n, i = [],
                ...
                s = B[e + " "];
            if (!s) {
                for (t || (t = S(e)), n = t.length; n--;) s = y(t[n]), s[$] ? i.push(s) : r.push(s);
            ...
            if (n = n || [], 1 === d.length) {
                if (s = d[0] = d[0].slice(0), s.length > 2 && "ID" === (o = s[0]).type && x.getById && 9 === t.nodeType && N && C.relative[s[1].type]) {
                    if (t = (C.find.ID(o.matches[0].replace(we, xe), t) || [])[0], !t) return n;
                    u && (t = t.parentNode), e = e.slice(s.shift().value.length)
                }
                for (r = he.needsContext.test(e) ? 0 : s.length; r-- && (o = s[r], !C.relative[a = o.type]);)
                    if ((l = C.find[a]) && (i = l(o.matches[0].replace(we, xe), ye.test(s[0].type) && c(t.parentNode) || t))) {
                        if (s.splice(r, 1), e = i.length && p(s), !e) return K.apply(n, i), n;
                        break
                    }
            }
            return (u || k(e, d))(i, t, !N, n, !t || ye.test(e) && c(t.parentNode) || t), n
        }, x.sortStable = $.split("").sort(Y).join("") === $, x.detectDuplicates = !!P, D(), x.sortDetached = r(function(e) {
    ...
    var me, ve = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        ye = se.fn.init = function(e, t, n) {
            ...
            if (n = n || me, "string" == typeof e) {
                ...
                if (i[1]) {
                    if (t = t instanceof se ? t[0] : t, se.merge(this, se.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)), fe.test(i[1]) && se.isPlainObject(t))
    ...
    se.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, i = 0, r = this.length, s = [], o = he.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; i < r; i++)
                for (n = this[i]; n && n !== t; n = n.parentNode)
                    if (n.nodeType < 11 && (o ? o.index(n) > -1 : 1 === n.nodeType && se.find.matchesSelector(n, e))) {
                        s.push(n);
                        break
        ...
        se.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = se.filter(i, r)), this.length > 1 && (we[e] || se.uniqueSort(r), be.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var xe = /\S+/g;
    se.Callbacks = function(e) {
                ...
                add: function() {
                    return o && (n && !t && (l = o.length - 1, a.push(n)), function i(t) {
                        se.each(t, function(t, n) {
                            se.isFunction(n) ? e.unique && c.has(n) || o.push(n) : n && n.length && "string" !== se.type(n) && i(n)
                        })
                        ...
                        return se.Deferred(function(n) {
                            se.each(t, function(t, s) {
                                ...
                                r[s[1]](function() {
                                    ...
                                    e && se.isFunction(e.promise) ? e.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[s[0] + "With"](this === i ? n.promise() : this, o ? [e] : arguments)
                                })
                            }), e = null
                        }).promise()
                    },
        ...
        when: function(e) {
            var t, n, i, r = 0,
                s = Q.call(arguments),
                o = s.length,
                a = 1 !== o || e && se.isFunction(e.promise) ? o : 0,
                l = 1 === a ? e : se.Deferred(),
                u = function(e, n, i) {
                    return function(r) {
            ...
            if (o > 1)
                for (t = new Array(o), n = new Array(o), i = new Array(o); r < o; r++) s[r] && se.isFunction(s[r].promise) ? s[r].promise().progress(u(r, n, t)).done(u(r, i, s)).fail(l.reject) : --a;
    ...
    se.fn.ready = function(e) {
        ...
        ready: function(e) {
            (e === !0 ? --se.readyWait : se.isReady) || (se.isReady = !0, e !== !0 && --se.readyWait > 0 || (Ce.resolveWith(Z, [se]), se.fn.triggerHandler && (se(Z).triggerHandler("ready"), se(Z).off("ready"))))
        }
    }), se.ready.promise = function(t) {
        return Ce || (Ce = se.Deferred(), "complete" === Z.readyState || "loading" !== Z.readyState && !Z.documentElement.doScroll ? e.setTimeout(se.ready) : (Z.addEventListener("DOMContentLoaded", o), e.addEventListener("load", o))), Ce.promise(t)
    }, se.ready.promise();
    var Te = function(e, t, n, i, r, s, o) {
            ...
            } else if (void 0 !== i && (r = !0, se.isFunction(i) || (o = !0), u && (o ? (t.call(e, i), t = null) : (u = t, t = function(e, t, n) {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== s) {
                if (void 0 === t) this.register(e);
                    ...
                    se.isArray(t) ? i = t.concat(t.map(se.camelCase)) : (r = se.camelCase(t), t in s ? i = [t, r] : (i = r, i = i in s ? [i] : i.match(xe) || [])), n = i.length;
                    for (; n--;) delete s[i[n]]
    ...
    se.extend({
        ...
        data: function(e, t) {
            var n, i, r, s = this[0],
                o = s && s.attributes;
            if (void 0 === e) {
                if (this.length && (r = ke.get(s), 1 === s.nodeType && !Se.get(s, "hasDataAttrs"))) {
                    for (n = o.length; n--;) o[n] && (i = o[n].name, 0 === i.indexOf("data-") && (i = se.camelCase(i.slice(5)), l(s, i, r[i])));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n, i;
                if (s && void 0 === t) {
                    if (n = ke.get(s, e) || ke.get(s, e.replace(Ae, "-$&").toLowerCase()), void 0 !== n) return n;
                    if (i = se.camelCase(e), n = ke.get(s, i), void 0 !== n) return n;
        ...
        queue: function(e, t, n) {
            var i;
            if (e) return t = (t || "fx") + "queue", i = Se.get(e, t), n && (!i || se.isArray(n) ? i = Se.access(e, t, se.makeArray(n)) : i.push(n)), i || []
        },
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; o--;) n = Se.get(s[o], e + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
    ...
    se.event = {
        ...
        add: function(e, t, n, i, r) {
            var s, o, a, l, u, c, d, p, h, f, g, m = Se.get(e);
            if (m)
                for (n.handler && (s = n, n = s.handler, r = s.selector), n.guid || (n.guid = se.guid++), (l = m.events) || (l = m.events = {}), (o = m.handle) || (o = m.handle = function(t) {
                        return "undefined" != typeof se && se.event.triggered !== t.type ? se.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(xe) || [""], u = t.length; u--;) a = He.exec(t[u]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h && (d = se.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) || h, d = se.event.special[h] || {}, c = se.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, s), (p = l[h]) || (p = l[h] = [], p.delegateCount = 0, d.setup && d.setup.call(e, i, f, o) !== !1 || e.addEventListener && e.addEventListener(h, o)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, c) : p.push(c), se.event.global[h] = !0)
        },
        remove: function(e, t, n, i, r) {
            var s, o, a, l, u, c, d, p, h, f, g, m = Se.hasData(e) && Se.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(xe) || [""], u = t.length; u--;)
                    if (a = He.exec(t[u]) || [], h = g = a[1], f = (a[2] || "").split(".").sort(), h) {
                        for (d = se.event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, p = l[h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = p.length; s--;) c = p[s], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(s, 1), c.selector && p.delegateCount--, d.remove && d.remove.call(e, c));
                        o && !p.length && (d.teardown && d.teardown.call(e, f, m.handle) !== !1 || se.removeEvent(e, h, m.handle), delete l[h])
                    } else
            ...
            if (a[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
                for (o = se.event.handlers.call(this, e, l), t = 0;
                    ...
                    for (e.currentTarget = r.elem, n = 0;
                        (s = r.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(s.namespace) || (e.handleObj = s, e.data = s.data, i = ((se.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, a), void 0 !== i && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                        for (i = [], n = 0; n < a; n++) s = t[n], r = s.selector + " ", void 0 === i[r] && (i[r] = s.needsContext ? se(r, this).index(l) > -1 : se.find(r, this, null, [l]).length), i[r] && i.push(s);
                        i.length && o.push({
                            elem: l,
                            handlers: i
                        })
        ...
        fix: function(e) {
            ...
            var t, n, i, r = e.type,
                s = e,
                o = this.fixHooks[r];
            for (o || (this.fixHooks[r] = o = $e.test(r) ? this.mouseHooks : Ve.test(r) ? this.keyHooks : {}), i = o.props ? this.props.concat(o.props) : this.props, e = new se.Event(s), t = i.length; t--;) n = i[t], e[n] = s[n];
        ...
        se.event.special[e] = {
            ...
            handle: function(e) {
                var n, i = this,
                    r = e.relatedTarget,
                    s = e.handleObj;
                return r && (r === i || se.contains(i, r)) || (e.type = s.origType, n = s.handler.apply(this, arguments), e.type = t), n
            }
        }
    }), se.fn.extend({
        on: function(e, t, n, i) {
    ...
    se.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e)))
                for (o = c(a), s = c(e), i = 0, r = s.length; i < r; i++) x(s[i], o[i]);
            if (t)
                if (n)
                    for (s = s || c(e), o = o || c(a), i = 0, r = s.length; i < r; i++) w(s[i], o[i]);
                else w(e, a);
            return o = c(a, "script"), o.length > 0 && d(o, !l && c(e, "script")), a
        },
        cleanData: function(e) {
            for (var t, n, i, r = se.event.special, s = 0; void 0 !== (n = e[s]); s++)
                if (_e(n)) {
                    if (t = n[Se.expando]) {
                        if (t.events)
        ...
        html: function(e) {
            return Te(this, function(e) {
                ...
                if ("string" == typeof e && !Ue.test(e) && !Ie[(Ne.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        se.fn[e] = function(e) {
            for (var n, i = [], r = se(e), s = r.length - 1, o = 0; o <= s; o++) n = o === s ? this : this.clone(!0), se(r[o])[t](n), K.apply(i, n.get());
    ...
    ! function() {
        function t() {
            a.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", a.innerHTML = "", Ke.appendChild(o);
            var t = e.getComputedStyle(a);
            n = "1%" !== t.top, s = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" === t.marginRight, Ke.removeChild(o)
        }
        var n, i, r, s, o = Z.createElement("div"),
            a = Z.createElement("div");
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", ie.clearCloneStyle = "content-box" === a.style.backgroundClip, o.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", o.appendChild(a), se.extend(ie, {
            ...
            reliableMarginRight: function() {
                ...
                return n.style.cssText = a.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", a.style.width = "1px", Ke.appendChild(o), t = !parseFloat(e.getComputedStyle(n).marginRight), Ke.removeChild(o), a.removeChild(n), t
            }
        }))
    }();
    ...
    se.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, s, o, a = se.camelCase(t),
                    l = e.style;
                return t = se.cssProps[a] || (se.cssProps[a] = A(a) || a), o = se.cssHooks[t] || se.cssHooks[a], void 0 === n ? o && "get" in o && void 0 !== (r = o.get(e, !1, i)) ? r : l[t] : (s = typeof n, "string" === s && (r = Pe.exec(n)) && r[1] && (n = u(e, t, r), s = "number"), null != n && n === n && ("number" === s && (n += r && r[3] || (se.cssNumber[a] ? "" : "px")), ie.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), o && "set" in o && void 0 === (n = o.set(e, n, i)) || (l[t] = n)), void 0)
            }
        },
        css: function(e, t, n, i) {
            var r, s, o, a = se.camelCase(t);
            return t = se.cssProps[a] || (se.cssProps[a] = A(a) || a), o = se.cssHooks[t] || se.cssHooks[a], o && "get" in o && (r = o.get(e, !0, n)), void 0 === r && (r = k(e, t, i)), "normal" === r && t in tt && (r = tt[t]), "" === n || n ? (s = parseFloat(r), n === !0 || isFinite(s) ? s || 0 : r) : r
        }
    }), se.each(["height", "width"], function(e, t) {
        se.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return Je.test(se.css(e, "display")) && 0 === e.offsetWidth ? Ge(e, et, function() {
                    return D(e, t, i)
                }) : D(e, t, i)
            },
            set: function(e, n, i) {
                var r, s = i && Qe(e),
                    o = i && P(e, t, i, "border-box" === se.css(e, "boxSizing", !1, s), s);
                return o && (r = Pe.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = se.css(e, t)), O(e, n, o)
            }
        }
        ...
        se.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0, r = {}, s = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) r[e + De[i] + t] = s[i] || s[i - 2] || s[0];
                return r
            }
        }, We.test(e) || (se.cssHooks[e + t].set = O)
    }), se.fn.extend({
        css: function(e, t) {
            return Te(this, function(e, t, n) {
                var i, r, s = {},
                    o = 0;
                if (se.isArray(t)) {
                    for (i = Qe(e), r = t.length; o < r; o++) s[t[o]] = se.css(e, t[o], !1, i);
                    return s
                }
        ...
        init: function(e, t, n, i, r, s) {
            this.elem = e, this.prop = n, this.easing = r || se.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = i, this.unit = s || (se.cssNumber[n] ? "" : "px")
        },
        cur: function() {
        ...
        run: function(e) {
            ...
            return this.options.duration ? this.pos = t = se.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : j.propHooks._default.set(this), this
        }
            ...
            finish: function(e) {
                return e !== !1 && (e = e || "fx"), this.each(function() {
                    var t, n = Se.get(this),
                        ...
                        s = se.timers,
                        o = i ? i.length : 0;
                    for (n.finish = !0, se.queue(this, e, []), r && r.stop && r.stop.call(this, !0), t = s.length; t--;) s[t].elem === this && s[t].queue === e && (s[t].anim.stop(!0), s.splice(t, 1));
    ...
    se.fn.extend({
        ...
        removeAttr: function(e, t) {
            var n, i, r = 0,
                s = t && t.match(xe);
            if (s && 1 === e.nodeType)
                for (; n = s[r++];) i = se.propFix[n] || n, se.expr.match.bool.test(n) && (e[i] = !1), e.removeAttribute(n)
        }
    }), lt = {
        set: function(e, t, n) {
        ...
        ut[t] = function(e, t, i) {
            var r, s;
            return i || (s = ut[t], ut[t] = r, r = null != n(e, t, i) ? t.toLowerCase() : null, ut[t] = s), r
        }
    });
    ...
    se.fn.extend({
        ...
        prop: function(e, t, n) {
            var i, r, s = e.nodeType;
            if (3 !== s && 8 !== s && 2 !== s) return 1 === s && se.isXMLDoc(e) || (t = se.propFix[t] || t, r = se.propHooks[t]), void 0 !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : e[t] = n : r && "get" in r && null !== (i = r.get(e, t)) ? i : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    se.fn.extend({
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(xe) || []; n = this[l++];)
                    if (r = H(n), i = 1 === n.nodeType && (" " + r + " ").replace(pt, " ")) {
                        for (o = 0; s = t[o++];) i.indexOf(" " + s + " ") < 0 && (i += s + " ");
                        a = se.trim(i), r !== a && n.setAttribute("class", a)
                    } return this
        },
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : se.isFunction(e) ? this.each(function(n) {
                ...
                var t, i, r, s;
                if ("string" === n)
                    for (i = 0, r = se(this), s = e.match(xe) || []; t = s[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = H(this), t && Se.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Se.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
        ...
        val: function(e) {
            var t, n, i, r = this[0]; {
                if (arguments.length) return i = se.isFunction(e), this.each(function(n) {
                    var r;
                    1 === this.nodeType && (r = i ? e.call(this, n, se(this).val()) : e, null == r ? r = "" : "number" == typeof r ? r += "" : se.isArray(r) && (r = se.map(r, function(e) {
                        return null == e ? "" : e + ""
                    })), t = se.valHooks[this.type] || se.valHooks[this.nodeName.toLowerCase()], t && "set" in t && void 0 !== t.set(this, r, "value") || (this.value = r))
                });
                if (r) return t = se.valHooks[r.type] || se.valHooks[r.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(ht, "") : null == n ? "" : n)
            }
        }
    }), se.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, s = se.makeArray(t), o = r.length; o--;) i = r[o], (i.selected = se.inArray(se.valHooks.option.get(i), s) > -1) && (n = !0);
    ...
    se.extend(se.event, {
        trigger: function(t, n, i, r) {
            var s, o, a, l, u, c, d, p = [i || Z],
                h = ne.call(t, "type") ? t.type : t,
                f = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = a = i = i || Z, 3 !== i.nodeType && 8 !== i.nodeType && !gt.test(h + se.event.triggered) && (h.indexOf(".") > -1 && (f = h.split("."), h = f.shift(), f.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[se.expando] ? t : new se.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = f.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : se.makeArray(n, [t]), d = se.event.special[h] || {}, r || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!r && !d.noBubble && !se.isWindow(i)) {
                    for (l = d.delegateType || h, gt.test(l + h) || (o = o.parentNode); o; o = o.parentNode) p.push(o), a = o;
                    a === (i.ownerDocument || Z) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (s = 0;
                    (o = p[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? l : d.bindType || h, c = (Se.get(o, "events") || {})[t.type] && Se.get(o, "handle"), c && c.apply(o, n), c = u && o[u], c && c.apply && _e(o) && (t.result = c.apply(o, n), t.result === !1 && t.preventDefault());
                return t.type = h, r || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !_e(i) || u && se.isFunction(i[h]) && !se.isWindow(i) && (a = i[u], a && (i[u] = null), se.event.triggered = h, i[h](), se.event.triggered = void 0, a && (i[u] = a)), t.result
            }
        },
    ...
    At.href = mt.href, se.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var u, d, y, b, x, T = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), r = void 0, o = a || "", C.readyState = t > 0 ? 4 : 0, u = t >= 200 && t < 300 || 304 === t, i && (b = z(p, C, i)), b = B(p, b, C, u), u ? (p.ifModified && (x = C.getResponseHeader("Last-Modified"), x && (se.lastModified[s] = x), x = C.getResponseHeader("etag"), x && (se.etag[s] = x)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = b.state, d = b.data, y = b.error, u = !y)) : (y = T, !t && T || (T = "error", t < 0 && (t = 0))), C.status = t, C.statusText = (n || T) + "", u ? g.resolveWith(h, [d, T, C]) : g.rejectWith(h, [C, T, y]), C.statusCode(v), v = void 0, c && f.trigger(u ? "ajaxSuccess" : "ajaxError", [C, p, u ? d : y]), m.fireWith(h, [C, T]), c && (f.trigger("ajaxComplete", [C, p]), --se.active || se.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, s, o, a, l, u, c, d, p = se.ajaxSetup({}, n),
                h = p.context || p,
                f = p.context && (h.nodeType || h.jquery) ? se(h) : se.event,
                g = se.Deferred(),
            ...
            if (g.promise(C).complete = m.add, C.success = C.done, C.error = C.fail, p.url = ((t || p.url || mt.href) + "").replace(bt, "").replace(_t, mt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = se.trim(p.dataType || "*").toLowerCase().match(xe) || [""], null == p.crossDomain) {
                u = Z.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = se.param(p.data, p.traditional)), U(St, p, n, C), 2 === w) return C;
            c = se.event && p.global, c && 0 === se.active++ && se.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), s = p.url, p.hasContent || (p.data && (s = p.url += (yt.test(s) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = wt.test(s) ? s.replace(wt, "$1_=" + vt++) : s + (yt.test(s) ? "&" : "?") + "_=" + vt++)), p.ifModified && (se.lastModified[s] && C.setRequestHeader("If-Modified-Since", se.lastModified[s]), se.etag[s] && C.setRequestHeader("If-None-Match", se.etag[s])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && C.setRequestHeader("Content-Type", p.contentType), C.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Et + "; q=0.01" : "") : p.accepts["*"]);
        ...
        se[t] = function(e, n, i, r) {
            return se.isFunction(n) && (r = r || i, i = n, n = void 0), se.ajax(se.extend({
                url: e,
                type: t,
                dataType: r,
                data: n,
    ...
    se.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !se(this).is(":disabled") && jt.test(this.nodeName) && !Ft.test(e) && (this.checked || !je.test(e))
            }).map(function(e, t) {
                var n = se(this).val();
    ...
    var Nt = {
        ...
        Mt = se.ajaxSettings.xhr();
    ie.cors = !!Mt && "withCredentials" in Mt, ie.ajax = Mt = !!Mt, se.ajaxTransport(function(t) {
        var n, i;
        if (ie.cors || Mt && !t.crossDomain) return {
            send: function(r, s) {
                var o, a = t.xhr();
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? s(0, "error") : s(a.status, a.statusText) : s(Nt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    se.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = It.pop() || se.expando + "_" + vt++;
            return this[e] = !0, e
        }
    }), se.ajaxPrefilter("json jsonp", function(t, n, i) {
        var r, s, o, a = t.jsonp !== !1 && (Lt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Lt.test(t.data) && "data");
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = se.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Lt, "$1" + r) : t.jsonp !== !1 && (t.url += (yt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return o || se.error(r + " was not called"), o[0]
        }, t.dataTypes[0] = "json", s = e[r], e[r] = function() {
            o = arguments
        }, i.always(function() {
            void 0 === s ? se(e).removeProp(r) : e[r] = s, t[r] && (t.jsonpCallback = n.jsonpCallback, It.push(r)), o && se.isFunction(s) && s(o[0]), o = s = void 0
        }), "script"
        ...
        var i = fe.exec(e),
            r = !n && [];
        return i ? [t.createElement(i[1])] : (i = p([e], t, r), r && r.length && se(r).remove(), se.merge([], i.childNodes))
    };
    var Vt = se.fn.load;
    se.fn.load = function(e, t, n) {
        ...
        var i, r, s, o = this,
            a = e.indexOf(" ");
        return a > -1 && (i = se.trim(e.slice(a)), e = e.slice(0, a)), se.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), o.length > 0 && se.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        }).done(function(e) {
            s = arguments, o.html(i ? se("<div>").append(se.parseHTML(e)).find(i) : e)
        ...
        setOffset: function(e, t, n) {
            var i, r, s, o, a, l, u, c = se.css(e, "position"),
                d = se(e),
                p = {};
            "static" === c && (e.style.position = "relative"), a = d.offset(), s = se.css(e, "top"), l = se.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (s + l).indexOf("auto") > -1, u ? (i = d.position(), o = i.top, r = i.left) : (o = parseFloat(s) || 0, r = parseFloat(l) || 0), se.isFunction(t) && (t = t.call(e, n, se.extend({}, a))), null != t.top && (p.top = t.top - a.top + o), null != t.left && (p.left = t.left - a.left + r), "using" in t ? t.using.call(e, p) : d.css(p)
        }
    }, se.fn.extend({
        offset: function(e) {
            ...
            var t, n, i = this[0],
                ...
                s = i && i.ownerDocument;
            if (s) return t = s.documentElement, se.contains(t, i) ? (r = i.getBoundingClientRect(), n = X(s), {
        ...
        se.cssHooks[t] = E(ie.pixelPosition, function(e, n) {
            if (n) return n = k(e, t), Ze.test(n) ? se(e).position()[t] + "px" : n
        })
    }), se.each({
        Height: "height",
        Width: "width"
        ...
        se.each({
            ...
            se.fn[i] = function(i, r) {
                ...
                return Te(this, function(t, n, i) {
                    var r;
                    return se.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === i ? se.css(t, n, o) : se.style(t, n, i, o)
                }, t, s ? i : void 0, s, null)
            }
        })
    }), se.fn.extend({
    ...
    return se.noConflict = function(t) {
        return e.$ === se && (e.$ = Ht), t && e.jQuery === se && (e.jQuery = $t), se
    }, t || (e.jQuery = e.$ = se), se
}),
function(e) {
    function t(e) {
    ...
    if (!e.jQuery) {
        ...
        n.isWindow = function(e) {
            ...
            if (i) {
                if (a)
                    for (; s < o && (r = n.apply(e[s], i), r !== !1); s++);
                else
                    for (s in e)
                        if (r = n.apply(e[s], i), r === !1) break
            } else if (a)
                for (; s < o && (r = n.call(e[s], s, e[s]), r !== !1); s++);
            else
                for (s in e)
                    if (r = n.call(e[s], s, e[s]), r === !1) break;
            return e
            ...
            var e, t, i, r, s, o, a = arguments[0] || {},
                l = 1,
                u = arguments.length,
                c = !1;
            for ("boolean" == typeof a && (c = a, a = arguments[l] || {}, l++), "object" != typeof a && "function" !== n.type(a) && (a = {}), l === u && (a = this, l--); l < u; l++)
                if (null != (s = arguments[l]))
                    for (r in s) e = a[r], i = s[r], a !== i && (c && i && (n.isPlainObject(i) || (t = n.isArray(i))) ? (t ? (t = !1, o = e && n.isArray(e) ? e : []) : o = e && n.isPlainObject(e) ? e : {}, a[r] = n.extend(c, o, i)) : void 0 !== i && (a[r] = i));
            return a
            ...
            if (e) {
                i = (i || "fx") + "queue";
                var o = n.data(e, i);
                return r ? (!o || n.isArray(r) ? o = n.data(e, i, s(r)) : o.push(r), o) : o || []
            }
            ...
            n.each(e.nodeType ? [e] : e, function(e, i) {
                ...
                var r = n.queue(i, t),
                    s = r.shift();
                "inprogress" === s && (s = r.shift()), s && ("fx" === t && r.unshift("inprogress"), s.call(i, function() {
                    n.dequeue(i, t)
                }))
            })
        }, n.fn = n.prototype = {
...
function(e) {
    ...
    return function(e, t, n, i) {
        ...
        function l(e, n, i, r) {
            ...
            function p(t, n, r) {
                var s, o, a = 0;
                do o = n + (r - n) / 2, s = l(o, e, i) - t, s > 0 ? r = o : n = o; while (Math.abs(s) > v && ++a < y);
                return o
            }

            function h(t) {
                for (var n = 0, r = 1, s = b - 1; r != s && T[r] <= t; ++r) n += w;
                --r;
            ...
            var T = x ? new Float32Array(b) : new Array(b),
                _ = !1,
                S = function(t) {
                    return _ || f(), e === n && i === r ? t : 0 === t ? 0 : 1 === t ? 1 : l(h(t), n, r)
                };
        ...
        function u(e, t) {
            var n = e;
            return g.isString(e) ? b.Easings[e] || (n = !1) : n = g.isArray(e) && 1 === e.length ? a.apply(null, e) : g.isArray(e) && 2 === e.length ? w.apply(null, e.concat([t])) : !(!g.isArray(e) || 4 !== e.length) && l.apply(null, e), n === !1 && (n = b.Easings[b.defaults.easing] ? b.defaults.easing : y), n
        }
                ...
                for (var s = 0; s < n; s++)
                    if (b.State.calls[s]) {
                        var a = b.State.calls[s],
                            ...
                            f = !!h,
                            m = null;
                        h || (h = b.State.calls[s][3] = t - 16);
                        for (var v = Math.min((t - h) / u.duration, 1), y = 0, w = l.length; y < w; y++) {
                            var C = l[y],
                                _ = C.element;
                            if (o(_)) {
                                var S = !1;
                                if (u.display !== i && null !== u.display && "none" !== u.display) {
                                    if ("flex" === u.display) {
                                        ...
                                        p.each(k, function(e, t) {
                                            x.setPropertyValue(_, "display", t)
                                        })
                                    }
                                    x.setPropertyValue(_, "display", u.display)
                                }
                                u.visibility !== i && "hidden" !== u.visibility && x.setPropertyValue(_, "visibility", u.visibility);
                                for (var E in C)
                                    if ("element" !== E) {
                                        var A, O = C[E],
                                            P = g.isString(O.easing) ? b.Easings[O.easing] : O.easing;
                                        if (1 === v) A = O.endValue;
                                        else {
                                            var D = O.endValue - O.startValue;
                                            if (A = O.startValue + D * P(v, u, D), !f && A === O.currentValue) continue
                                        }
                                        if (O.currentValue = A, "tween" === E) m = A;
                                        else {
                                            if (x.Hooks.registered[E]) {
                                                var F = x.Hooks.getRoot(E),
                                                    j = o(_).rootPropertyValueCache[F];
                                                j && (O.rootPropertyValue = j)
                                            }
                                            var N = x.setPropertyValue(_, E, O.currentValue + (0 === parseFloat(A) ? "" : O.unitType), O.rootPropertyValue, O.scrollData);
                                            x.Hooks.registered[E] && (x.Normalizations.registered[F] ? o(_).rootPropertyValueCache[F] = x.Normalizations.registered[F]("extract", null, N[1]) : o(_).rootPropertyValueCache[F] = N[1]), "transform" === N[0] && (S = !0)
                                        }
                                    } u.mobileHA && o(_).transformCache.translate3d === i && (o(_).transformCache.translate3d = "(0px, 0px, 0px)", S = !0), S && x.flushTransformCache(_)
                            }
                        }
                        u.display !== i && "none" !== u.display && (b.State.calls[s][2].display = !1), u.visibility !== i && "hidden" !== u.visibility && (b.State.calls[s][2].visibility = !1), u.progress && u.progress.call(a[1], a[1], v, Math.max(0, h + u.duration - t), h, m), 1 === v && d(s)
                    }
            }
        ...
        function d(e, t) {
            ...
            for (var n = b.State.calls[e][0], r = b.State.calls[e][1], s = b.State.calls[e][2], a = b.State.calls[e][4], l = !1, u = 0, c = n.length; u < c; u++) {
                var d = n[u].element;
                if (t || s.loop || ("none" === s.display && x.setPropertyValue(d, "display", s.display), "hidden" === s.visibility && x.setPropertyValue(d, "visibility", s.visibility)), s.loop !== !0 && (p.queue(d)[1] === i || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && o(d)) {
                    ...
                    }), s.mobileHA && (h = !0, delete o(d).transformCache.translate3d), h && x.flushTransformCache(d), x.Values.removeClass(d, "velocity-animating")
                }
                ...
                a && s.loop !== !0 && a(r), o(d) && s.loop === !0 && !t && (p.each(o(d).tweensContainer, function(e, t) {
            ...
            b.State.calls[e] = !1;
            for (var g = 0, m = b.State.calls.length; g < m; g++)
        ...
        var p, h = function() {
            ...
            m = !1;
        if (e.fn && e.fn.jquery ? (p = e, m = !0) : p = t.Velocity.Utilities, h <= 8 && !m) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
        ...
        var w = function() {
            ...
            return function i(e, t, r) {
                var s, o, a, l = {
                    ...
                    d = 1e-4,
                    p = .016;
                for (e = parseFloat(e) || 500, t = parseFloat(t) || 20, r = r || null, l.tension = e, l.friction = t, s = null !== r, s ? (c = i(e, t), o = c / r * p) : o = p;;)
                    if (a = n(a || l, o), u.push(1 + a.x), c += 16, !(Math.abs(a.x) > d && Math.abs(a.v) > d)) break;
                return s ? function(e) {
        ...
        var x = b.CSS = {
            ...
            Hooks: {
                ...
                register: function() {
                    ...
                    if (h)
                        for (n in x.Hooks.templates) {
                            ...
                            "Color" === r[0] && (r.push(r.shift()), s.push(s.shift()), x.Hooks.templates[n] = [r.join(" "), s.join(" ")])
                        }
                    for (n in x.Hooks.templates) {
                        i = x.Hooks.templates[n], r = i[0].split(" ");
                        for (var e in r) {
                ...
                injectValue: function(e, t, n) {
                    ...
                    if (i) {
                        var r, s, o = i[0],
                            a = i[1];
                        return n = x.Hooks.cleanRootPropertyValue(o, n), r = n.toString().match(x.RegEx.valueSplit), r[a] = t, s = r.join(" ")
                    }
                    return n
                }
            },
            Normalizations: {
                ...
                register: function() {
                    h <= 9 || b.State.isGingerbread || (x.Lists.transformsBase = x.Lists.transformsBase.concat(x.Lists.transforms3D));
                            ...
                            switch (e) {
                                ...
                                case "inject":
                                    ...
                                    switch (t.substr(0, t.length - 1)) {
                                        ...
                                        case "scal":
                                        case "scale":
                                            b.State.isAndroid && o(n).transformCache[t] === i && r < 1 && (r = 1), s = !/(\d)$/i.test(r);
                                            break;
                                        case "skew":
                                            s = !/(deg|\d)$/i.test(r);
                                            break;
                    ...
                    for (var e = 0; e < x.Lists.colors.length; e++) ! function() {
                        ...
                        x.Normalizations.registered[t] = function(e, n, r) {
                            switch (e) {
                                ...
                                case "extract":
                                    var s;
                                    if (x.RegEx.wrappedValueAlreadyExtracted.test(r)) s = r;
                                    else {
                                        var o, a = {
                                            black: "rgb(0, 0, 0)",
                                            blue: "rgb(0, 0, 255)",
                                        ...
                                        /^[A-z]+$/i.test(r) ? o = a[r] !== i ? a[r] : a.black : x.RegEx.isHex.test(r) ? o = "rgb(" + x.Values.hexToRgb(r).join(" ") + ")" : /^rgba?\(/i.test(r) || (o = a.black), s = (o || r).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                    }
                                    return h <= 8 || 3 !== s.split(" ").length || (s += " 1"), s;
                                case "inject":
                                    return h <= 8 ? 4 === r.split(" ").length && (r = r.split(/\s+/).slice(0, 3).join(" ")) : 3 === r.split(" ").length && (r += " 1"), (h <= 8 ? "rgb" : "rgba") + "(" + r.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")"
                            }
                        }
                    }()
                }
            ...
            getPropertyValue: function(e, n, r, s) {
                ...
                if (x.Hooks.registered[n]) {
                    ...
                    var d, f;
                    d = x.Normalizations.registered[n]("name", e), "transform" !== d && (f = a(e, x.Names.prefixCheck(d)[0]), x.Values.isCSSNullValue(f) && x.Hooks.templates[n] && (f = x.Hooks.templates[n][1])), l = x.Normalizations.registered[n]("extract", e, f)
                }
                if (!/^[\d-]/.test(l))
            ...
            setPropertyValue: function(e, n, i, r, s) {
                ...
                if ("scroll" === n) s.container ? s.container["scroll" + s.direction] = i : "Left" === s.direction ? t.scrollTo(i, s.alternateValue) : t.scrollTo(s.alternateValue, i);
                else if (x.Normalizations.registered[n] && "transform" === x.Normalizations.registered[n]("name", e)) x.Normalizations.registered[n]("inject", e, i), a = "transform", i = o(e).transformCache[n];
                else {
                    if (x.Hooks.registered[n]) {
                        var l = n,
                            u = x.Hooks.getRoot(n);
                    ...
                    if (x.Normalizations.registered[n] && (i = x.Normalizations.registered[n]("inject", e, i), n = x.Normalizations.registered[n]("name", e)), a = x.Names.prefixCheck(n)[0], h <= 8) try {
                        e.style[a] = i
                    } catch (c) {
                        b.debug && console.log("Browser does not support [" + i + "] for [" + a + "]")
                    } else o(e) && o(e).isSVG && x.Names.SVGAttribute(n) ? e.setAttribute(n, i) : e.style[a] = i;
            ...
            flushTransformCache: function(e) {
                ...
                if ((h || b.State.isAndroid && !b.State.isChrome) && o(e).isSVG) {
                    ...
                    p.each(o(e).transformCache, function(t) {
                        return r = o(e).transformCache[t], "transformPerspective" === t ? (s = r, !0) : (9 === h && "rotateZ" === t && (t = "rotate"), void(n += t + r + " "))
                    }), s && (n = "perspective" + s + " " + n)
                }
        ...
        x.Hooks.register(), x.Normalizations.register(), b.hook = function(e, t, n) {
            ...
            return e = s(e), p.each(e, function(e, s) {
                if (o(s) === i && b.init(s), n === i) r === i && (r = b.CSS.getPropertyValue(s, t));
                else {
                    var a = b.CSS.setPropertyValue(s, t, n);
                    "transform" === a[0] && b.CSS.flushTransformCache(s), r = a
                }
            }), r
        };
        var C = function() {
            ...
            function r() {
                function e(e) {
                    function d(e, t) {
                        var n = i,
                            r = i,
                            o = i;
                        return g.isArray(e) ? (n = e[0], !g.isArray(e[1]) && /^[\d-]/.test(e[1]) || g.isFunction(e[1]) || x.RegEx.isHex.test(e[1]) ? o = e[1] : (g.isString(e[1]) && !x.RegEx.isHex.test(e[1]) || g.isArray(e[1])) && (r = t ? e[1] : u(e[1], a.duration), e[2] !== i && (o = e[2]))) : n = e, t || (r = r || a.easing), g.isFunction(n) && (n = n.call(s, _, T)), g.isFunction(o) && (o = o.call(s, _, T)), [n || 0, r, o]
                    }
                    ...
                    function v() {
                        ...
                        if (r && i) l.emToPx = N.lastEmToPx, l.percentToPxWidth = N.lastPercentToPxWidth, l.percentToPxHeight = N.lastPercentToPxHeight;
                            ...
                            }), b.CSS.setPropertyValue(u, "paddingLeft", a + "em"), l.percentToPxWidth = N.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / a, l.percentToPxHeight = N.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / a, l.emToPx = N.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / a, e.myParent.removeChild(u)
                        }
                        return null === N.remToPx && (N.remToPx = parseFloat(x.getPropertyValue(n.body, "fontSize")) || 16), null === N.vwToPx && (N.vwToPx = parseFloat(t.innerWidth) / 100, N.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = N.remToPx, l.vwToPx = N.vwToPx, l.vhToPx = N.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), s), l
                    }
                    if (a.begin && 0 === _) try {
                        a.begin.call(f, f)
                    } catch (w) {
                    ...
                    if ("scroll" === A) {
                        var C, S, k, O = /^x$/i.test(a.axis) ? "Left" : "Top",
                            P = parseFloat(a.offset) || 0;
                        a.container ? g.isWrapped(a.container) || g.isNode(a.container) ? (a.container = a.container[0] || a.container, C = a.container["scroll" + O], k = C + p(s).position()[O.toLowerCase()] + P) : a.container = null : (C = b.State.scrollAnchor[b.State["scrollProperty" + O]], S = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === O ? "Top" : "Left")]], k = p(s).offset()[O.toLowerCase()] + P), l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: C,
                                currentValue: C,
                        ...
                        if (!o(s).tweensContainer) return void p.dequeue(s, a.queue);
                        "none" === o(s).opts.display && (o(s).opts.display = "auto"), "hidden" === o(s).opts.visibility && (o(s).opts.visibility = "visible"), o(s).opts.loop = !1, o(s).opts.begin = null, o(s).opts.complete = null, y.easing || delete a.easing, y.duration || delete a.duration, a = p.extend({}, o(s).opts, a);
                        var D = p.extend(!0, {}, o(s).tweensContainer);
                        for (var F in D)
                            if ("element" !== F) {
                                var j = D[F].startValue;
                                D[F].startValue = D[F].currentValue = D[F].endValue, D[F].endValue = j, g.isEmptyObject(y) || (D[F].easing = a.easing), b.debug && console.log("reverse tweensContainer (" + F + "): " + JSON.stringify(D[F]), s)
                            } l = D
                    } else if ("start" === A) {
                        var D;
                        o(s).tweensContainer && o(s).isAnimating === !0 && (D = o(s).tweensContainer), p.each(m, function(e, t) {
                            if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(e)) {
                                ...
                                if (x.RegEx.isHex.test(r)) {
                                    for (var a = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(r), u = o ? x.Values.hexToRgb(o) : i, c = 0; c < a.length; c++) {
                                        var p = [l[c]];
                                        s && p.push(s), u !== i && p.push(u[c]), m[e + a[c]] = p
                                    }
                                    delete m[e]
                                }
                            }
                        ...
                        for (var I in m) {
                            ...
                            var q = x.Hooks.getRoot(I),
                                U = !1;
                            if (o(s).isSVG || "tween" === q || x.Names.prefixCheck(q)[1] !== !1 || x.Normalizations.registered[q] !== i) {
                                (a.display !== i && null !== a.display && "none" !== a.display || a.visibility !== i && "hidden" !== a.visibility) && /opacity|filter/.test(I) && !H && 0 !== V && (H = 0), a._cacheValues && D && D[I] ? (H === i && (H = D[I].endValue + D[I].unitType), U = o(s).rootPropertyValueCache[q]) : x.Hooks.registered[I] ? H === i ? (U = x.getPropertyValue(s, q), H = x.getPropertyValue(s, I, U)) : U = x.Hooks.templates[q][1] : H === i && (H = x.getPropertyValue(s, I));
                                var R, z, B, Y = !1;
                                if (R = h(I, H), H = R[0], B = R[1], R = h(I, V), V = R[0].replace(/^([+-\/*])=/, function(e, t) {
                                        return Y = t, ""
                                    }), z = R[1], H = parseFloat(H) || 0, V = parseFloat(V) || 0, "%" === z && (/^(fontSize|lineHeight)$/.test(I) ? (V /= 100, z = "em") : /^scale/.test(I) ? (V /= 100, z = "") : /(Red|Green|Blue)$/i.test(I) && (V = V / 100 * 255, z = "")), /[\/*]/.test(Y)) z = B;
                                else if (B !== z && 0 !== H)
                                    if (0 === V) z = B;
                                    else {
                                        r = r || v();
                                ...
                                l[I] = {
                                    ...
                                    unitType: z,
                                    easing: $
                                }, b.debug && console.log("tweensContainer (" + I + "): " + JSON.stringify(l[I]), s)
                            } else b.debug && console.log("Skipping [" + q + "] due to a lack of browser support.")
                        }
                        l.element = s
                    }
                    l.element && (x.Values.addClass(s, "velocity-animating"), M.push(l), "" === a.queue && (o(s).tweensContainer = l, o(s).opts = a), o(s).isAnimating = !0, _ === T - 1 ? (b.State.calls.push([M, f, a, null, E.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : _++)
                }
                var r, s = this,
                    a = p.extend({}, b.defaults, y),
                    l = {};
                switch (o(s) === i && b.init(s), parseFloat(a.delay) && a.queue !== !1 && p.queue(s, a.queue, function(e) {
                ...
                b.mock !== !1 && (b.mock === !0 ? a.duration = a.delay = 1 : (a.duration *= parseFloat(b.mock) || 1, a.delay *= parseFloat(b.mock) || 1)), a.easing = u(a.easing, a.duration), a.begin && !g.isFunction(a.begin) && (a.begin = null), a.progress && !g.isFunction(a.progress) && (a.progress = null), a.complete && !g.isFunction(a.complete) && (a.complete = null), a.display !== i && null !== a.display && (a.display = a.display.toString().toLowerCase(), "auto" === a.display && (a.display = b.CSS.Values.getDisplayType(s))), a.visibility !== i && null !== a.visibility && (a.visibility = a.visibility.toString().toLowerCase()), a.mobileHA = a.mobileHA && b.State.isMobile && !b.State.isGingerbread, a.queue === !1 ? a.delay ? setTimeout(e, a.delay) : e() : p.queue(s, a.queue, function(t, n) {
                    return n === !0 ? (E.promise && E.resolver(f), !0) : (b.velocityQueueEntryFlag = !0, void e(t))
                }), "" !== a.queue && "fx" !== a.queue || "inprogress" === p.queue(s)[0] || p.dequeue(s)
            }
            var a, l, h, f, m, y, w = arguments[0] && (arguments[0].p || p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));
            if (g.isWrapped(this) ? (a = !1, h = 0, f = this, l = this) : (a = !0, h = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = s(f)) {
                ...
                a && b.Promise && (E.promise = new b.Promise(function(e, t) {
                ...
                switch (m) {
                    ...
                    case "stop":
                        p.each(f, function(e, t) {
                            o(t) && o(t).delayTimer && (clearTimeout(o(t).delayTimer.setTimeout), o(t).delayTimer.next && o(t).delayTimer.next(), delete o(t).delayTimer), "finishAll" !== m || y !== !0 && !g.isString(y) || (p.each(p.queue(t, g.isString(y) ? y : ""), function(e, t) {
                                g.isFunction(t) && t()
                        ...
                        return p.each(b.State.calls, function(e, t) {
                            t && p.each(t[1], function(n, r) {
                                var s = y === i ? "" : y;
                                return s !== !0 && t[2].queue !== s && (y !== i || t[2].queue !== !1) || void p.each(f, function(n, i) {
                                    i === r && ((y === !0 || g.isString(y)) && (p.each(p.queue(i, g.isString(y) ? y : ""), function(e, t) {
                                        g.isFunction(t) && t(null, !0)
                                    }), p.queue(i, g.isString(y) ? y : "", [])), "stop" === m ? (o(i) && o(i).tweensContainer && s !== !1 && p.each(o(i).tweensContainer, function(e, t) {
                                        t.endValue = t.currentValue
                                    }), O.push(e)) : "finish" !== m && "finishAll" !== m || (t[2].duration = 1))
                                })
                            })
                        }), "stop" === m && (p.each(O, function(e, t) {
                            d(t, !0)
                        ...
                        if (!p.isPlainObject(m) || g.isEmptyObject(m)) {
                            if (g.isString(m) && b.Redirects[m]) {
                                ...
                                return P.backwards === !0 && (f = p.extend(!0, [], f).reverse()), p.each(f, function(e, t) {
                                    parseFloat(P.stagger) ? P.delay = F + parseFloat(P.stagger) * e : g.isFunction(P.stagger) && (P.delay = F + P.stagger.call(t, e, T)), P.drag && (P.duration = parseFloat(D) || (/^(callout|transition)/.test(m) ? 1e3 : v), P.duration = Math.max(P.duration * (P.backwards ? 1 - e / T : (e + 1) / T), .75 * P.duration, 200)), b.Redirects[m].call(t, t, P || {}, e, T, f, E.promise ? E : i)
                                }), e()
                            }
                            var j = "Velocity: First argument (" + m + ") was not a property map, a known action, or a registered redirect. Aborting.";
                            return E.promise ? E.rejecter(new Error(j)) : console.log(j), e()
                        }
                        A = "start"
                }
                var N = {
                ...
                if (P.loop = parseInt(P.loop), I = 2 * P.loop - 1, P.loop)
                    for (var L = 0; L < I; L++) {
                        ...
                        L === I - 1 && (V.display = P.display, V.visibility = P.visibility, V.complete = P.complete), C(f, "reverse", V)
                    }
                return e()
            }
        };
        ...
        return b.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function() {
            ...
            b.Redirects["slide" + t] = function(e, n, r, s, o, a) {
                var l = p.extend({}, n),
                    u = l.begin,
                    c = l.complete,
                    d = {
            ...
            b.Redirects["fade" + t] = function(e, n, r, s, o, a) {
                var l = p.extend({}, n),
                    u = {
                        opacity: "In" === t ? 1 : 0
                    },
                    c = l.complete;
                r !== s - 1 ? l.complete = l.begin = null : l.complete = function() {
                    c && c.call(o, o), a && a.resolver(o)
...
function(e) {
    ...
    var r = function(e, t) {
            for (var n, i, r, s = e.split("").reverse(), o = [], a = 0, l = Math.ceil(e.length / t); a < l; a++) {
                for (n = "", r = 0; r < t && (i = a * t + r, i !== e.length); r++) n += s[i];
                o.push(n)
            }
            return o
        },
            ...
            separator: function(n, i, o) {
                return n = n || " ", i = i || 3, o = o || "",
                    function(a, l) {
                        ...
                        d.prop("number", a).text(c + o)
                    }
            }
        }
    }, e.fn.animateNumber = function() {
        for (var t = arguments[0], i = e.extend({}, n, t), r = e(this), s = [i], o = 1, a = arguments.length; o < a; o++) s.push(arguments[o]);
        if (t.numberStep) {
...
function(e) {
    e.easytabs = function(t, n) {
        ...
        u.init = function() {
            ...
            l.collapsible && !a && (e.hasClass(l.tabActiveClass) || e.hasClass(l.collapsedClass)) ? u.toggleTabCollapse(e, i, r, t) : e.hasClass(l.tabActiveClass) && i.hasClass(l.panelActiveClass) ? l.cache || y(e, i, r, t) : y(e, i, r, t)
        }, u.toggleTabCollapse = function(e, t, n, i) {
            u.panels.stop(!0, !0), h(c, "easytabs:before", [e, t, l]) && (u.tabs.filter("." + l.tabActiveClass).removeClass(l.tabActiveClass).children().removeClass(l.tabActiveClass), e.hasClass(l.collapsedClass) ? (!n || l.cache && e.parent().data("easytabs").cached || (c.trigger("easytabs:ajax:beforeSend", [e, t]), t.load(n, function(n, i, r) {
                e.parent().data("easytabs").cached = !0, c.trigger("easytabs:ajax:complete", [e, t, n, i, r])
            })), e.parent().removeClass(l.collapsedClass).addClass(l.tabActiveClass).children().removeClass(l.collapsedClass).addClass(l.tabActiveClass), t.addClass(l.panelActiveClass)[s.uncollapse](s.speed, l.transitionUncollapseEasing, function() {
                c.trigger("easytabs:midTransition", [e, t, l]), "function" == typeof i && i()
            })) : (e.addClass(l.collapsedClass).parent().addClass(l.collapsedClass), t.removeClass(l.panelActiveClass)[s.collapse](s.speed, l.transitionCollapseEasing, function() {
                c.trigger("easytabs:midTransition", [e, t, l]), "function" == typeof i && i()
            })))
            ...
            var e, t = window.location.hash.match(/^[^\?]*/)[0],
                n = u.matchTab(t);
            l.updateHash && (n.length ? (a = !0, u.selectTab(n)) : (e = u.matchInPanel(t), e.length ? (t = "#" + e.attr("id"), n = u.matchTab(t), a = !0, u.selectTab(n)) : i.hasClass(l.tabActiveClass) || l.cycle || ("" === t || u.matchTab(o).length || c.closest(t).length) && (a = !0, u.selectTab(r))))
        }, u.cycleTabs = function(t) {
            l.cycle && (t %= u.tabs.length, $tab = e(u.tabs[t]).children("a").first(), a = !0, u.selectTab($tab, function() {
                setTimeout(function() {
                    u.cycleTabs(t + 1)
                }, l.cycle)
            }))
        ...
        var h = function(t, n, i) {
            ...
            g = function() {
                var t, n = window.location.hash.match(/^[^\?]*/)[0],
                    s = u.matchTab(n).parent();
                1 === s.length ? (i = s, l.cycle = !1) : (t = u.matchInPanel(n), t.length ? (n = "#" + t.attr("id"), i = u.matchTab(n).parent()) : (i = u.tabs.parent().find(l.defaultTab), 0 === i.length && e.error("The specified default tab ('" + l.defaultTab + "') could not be found in the tab set ('" + l.tabs + "') out of " + u.tabs.length + " tabs."))), r = i.children("a").first(), m(s)
            },
            m = function(t) {
                var n, s;
                l.collapsible && 0 === t.length && l.collapsedByDefault ? i.addClass(l.collapsedClass).children().addClass(l.collapsedClass) : (n = e(i.data("easytabs").panel), s = i.data("easytabs").ajax, !s || l.cache && i.data("easytabs").cached || (c.trigger("easytabs:ajax:beforeSend", [r, n]), n.load(s, function(e, t, s) {
                        i.data("easytabs").cached = !0, c.trigger("easytabs:ajax:complete", [r, n, e, t, s])
                    })), i.data("easytabs").panel.show().addClass(l.panelActiveClass),
                    i.addClass(l.tabActiveClass).children().addClass(l.tabActiveClass)), c.trigger("easytabs:initialised", [r, n])
            },
            v = function() {
                u.tabs.children("a").bind(l.bind_str, function(t) {
                    l.cycle = !1, a = !1, u.selectTab(e(this)), t.preventDefault ? t.preventDefault() : t.returnValue = !1
                })
            },
            y = function(e, t, n, i) {
                if (u.panels.stop(!0, !0), h(c, "easytabs:before", [e, t, l])) {
                    var r, d, p, f, g = u.panels.filter(":visible"),
                        m = t.parent(),
                        v = window.location.hash.match(/^[^\?]*/)[0];
                    l.animate && (r = b(t), d = g.length ? w(g) : 0, p = r - d), o = v, f = function() {
                        c.trigger("easytabs:midTransition", [e, t, l]), l.animate && "fadeIn" == l.transitionIn && p < 0 && m.animate({
                            height: m.height() + p
                        }, s.halfSpeed).css({
                            "min-height": ""
                        }), l.updateHash && !a ? window.history.pushState ? window.history.pushState(null, null, "#" + t.attr("id")) : window.location.hash = "#" + t.attr("id") : a = !1, t[s.show](s.speed, l.transitionInEasing, function() {
                            m.css({
                                height: "",
                                "min-height": ""
        ...
        return this.each(function() {
            var i = e(this),
                r = i.data("easytabs");
            if (void 0 === r && (r = new e.easytabs(this, t), i.data("easytabs", r)), r.publicMethods[t]) return r.publicMethods[t](Array.prototype.slice.call(n, 1))
        })
    }
}(jQuery),
function(e) {
    ...
    e.fn.fitVids = function(t) {
        ...
        if (!document.getElementById("fit-vids-style")) {
            ...
            s.innerHTML = '<p>x</p><style id="fit-vids-style">' + r + "</style>", i.appendChild(s.childNodes[1])
        }
...
function(e, t) {
    ...
    ! function(e, t) {
        ...
        }, e(window).on("validatorsLoaded formValidationSetup", function(t, s, o) {
            s || (s = e("form")), n(o), i(o), r(s)
        })
    }(e),
    function(e) {
        "use strict";
        var t = {
            resolveErrorMessage: function(e, t, n, i, r) {
                var s = i.validationErrorMsgAttribute + "-" + n.replace("validate_", ""),
                    o = e.attr(s);
            ...
            setInlineMessage: function(t, n, i) {
                ...
                var r, s = document.getElementById(t.attr("name") + "_err_msg"),
                    o = !1,
                    a = function(i) {
                    ...
                    l = function() {
                        ...
                        o.find("." + i.errorMessageClass).each(function() {
                            if (this.inputReferer === t[0]) return s = e(this), !1
                        }), console.log(s), s ? n ? a(s) : s.remove() : "" !== n && (r = e('<div class="' + i.errorMessageClass + ' alert"></div>'), a(r), r[0].inputReferer = t[0], o.prepend(r))
                    };
                if (s) e.formUtils.warn("Using deprecated element reference " + s.id), o = e(s), l();
                    ...
                    r = u.find("." + i.errorMessageClass + ".help-block"), 0 === r.length && (r = e("<span></span>").addClass("help-block").addClass(i.errorMessageClass), r.appendTo(u)), a(r)
                }
            },
            setMessageInTopOfForm: function(t, n, i, r) {
                ...
                if ("function" != typeof i.submitErrorMessageCallback || (o = i.submitErrorMessageCallback(t, n, i), console.log(o), o)) {
                    ...
                    e.each(n, function(e, t) {
                        ...
                        s = s.replace("{" + e + "}", t)
                    }), o ? o.html(s) : t.children().eq(0).before(e(s))
                }
            }
        };
    ...
    function(e, t) {
        ...
        e.fn.validateOnBlur = function(t, n) {
            ...
            return t || (t = "data-validation-help"), this.find(".has-help-txt").valAttr("has-keyup-event", !1).removeClass("has-help-txt"), this.find("textarea,input").each(function() {
                ...
                s && i.addClass("has-help-txt").unbind("focus.help").bind("focus.help", function() {
                    ...
                    0 === t.length && (t = e("<span />").addClass(r).addClass("help").addClass("help-block").text(s).hide(), i.after(t)), t.fadeIn()
            ...
            this.each(function() {
                var i = e(this),
                    s = i.closest("form").get(0).validationConfig || {};
                i.one("validation", function(e, n) {
                    "function" == typeof t && t(n, this, e)
                }), i.validateInputOnBlur(r, e.extend({}, s, n || {}), !0)
            })
        ...
        }, e.fn.validateInputOnBlur = function(n, i, r, s) {
            if (e.formUtils.eventType = s, this.willPostponeValidation()) {
                var o = this,
                    a = this.valAttr("postpone") || 200;
                return t.postponedValidation = function() {
                    o.validateInputOnBlur(n, i, r, s), t.postponedValidation = !1
                }, setTimeout(function() {
            ...
            var l = this,
                u = l.closest("form"),
                c = e.formUtils.validateInput(l, n, i, u, s);
            ...
            var s = function(t, r) {
                    e.inArray(t, a) < 0 && a.push(t), l.push(r), r.attr("current-error", t), i && e.formUtils.dialogs.applyInputErrorStyling(r, n)
                },
                o = [],
                a = [],
                l = [],
            ...
            if (i && e.formUtils.dialogs.removeAllMessagesAndStyling(u, n), u.find("input,textarea,select").filter(':not([type="submit"],[type="button"])').each(function() {
                    var i = e(this),
                        r = i.attr("type"),
                        a = "radio" === r || "checkbox" === r,
                        l = i.attr("name");
                    if (!c(l, r) && (!a || e.inArray(l, o) < 0)) {
                        a && o.push(l);
                        var d = e.formUtils.validateInput(i, t, n, u, "submit");
                        d.shouldChangeDisplay && (d.isValid ? d.isValid && (i.valAttr("current-error", !1), e.formUtils.dialogs.applyInputSuccessStyling(i, n)) : s(d.errorMsg, i))
                    }
            ...
            return e.formUtils.isValidatingEntireForm = !1, !e.formUtils.haltValidation && l.length > 0 ? (i && ("top" === n.errorMessagePosition ? e.formUtils.dialogs.setMessageInTopOfForm(u, a, n, t) : e.each(l, function(t, i) {
                ...
                var r = !1,
                    s = function(t, n) {
                        ...
                        e.each(s, function(t, i) {
                            if (i = e.trim(i), 0 === i.length) a();
                            else {
                                var s = n + i + (".js" === i.slice(-3) ? "" : ".js"),
                                    o = document.createElement("SCRIPT");
                                s in e.formUtils.loadedModules ? a() : (e.formUtils.loadedModules[s] = 1, r = !0, o.type = "text/javascript", o.onload = a, o.src = s + (".dev.js" === s.slice(-7) ? l : ""), o.onerror = function() {
                                    e.formUtils.warn("Unable to load form validation module " + s)
    ...
    function(e, t) {
        ...
        e.formUtils = e.extend(e.formUtils || {}, {
            ...
            validateInput: function(t, n, i, r, s) {
                ...
                if (!u || l || t.valAttr("skipped")) return p.shouldChangeDisplay = i.addValidClassOnAll, p;
                var h = t.valAttr("ignore");
                return h && e.each(h.split(""), function(e, t) {
                    o = o.replace(new RegExp("\\" + t), "")
                }), e.split(u, function(a) {
                    ...
                    if ("validate_checkbox_group" === a && (t = r.find('[name="' + t.attr("name") + '"]:eq(0)')), ("keyup" !== s || l.validateOnKeyUp) && (c = l.validatorFunction(o, t, i, n, r)), !c) return d = e.formUtils.dialogs.resolveErrorMessage(t, l, a, i, n), !1
                }, " "), c === !1 ? (t.trigger("validation", !1), p.errorMsg = d, p.isValid = !1, p.shouldChangeDisplay = !0) : null === c ? p.shouldChangeDisplay = !1 : (t.trigger("validation", !0), p.shouldChangeDisplay = !0), "function" == typeof i.onElementValidate && null !== d && i.onElementValidate(p.isValid, t, r, d), t.trigger("afterValidation", [p, s]), p
            },
            parseDate: function(t, n, i) {
                var r, s, o, a, l = n.replace(/[a-zA-Z]/gi, "").substring(0, 1),
                    u = "^",
                    c = n.split(l || null);
                ...
                return o = p("m", c, r), s = p("d", c, r), a = p("y", c, r), !(2 === o && s > 28 && (a % 4 !== 0 || a % 100 === 0 && a % 400 !== 0) || 2 === o && s > 29 && (a % 4 === 0 || a % 100 !== 0 && a % 400 === 0) || o > 12 || 0 === o) && (!(this.isShortMonth(o) && s > 30 || !this.isShortMonth(o) && s > 31 || 0 === s) && [a, o, s])
            },
            ...
            lengthRestriction: function(t, n) {
                var i = parseInt(n.text(), 10),
                    ...
                    s = function() {
                        ...
                        if (e > i) {
                            var s = t.scrollTop();
                            t.val(t.val().substring(0, i)), t.scrollTop(s)
                        }
                        r = i - e, r < 0 && (r = 0), n.text(r)
                    };
                e(t).bind("keydown keyup keypress focus blur", s).bind("cut paste", function() {
                    setTimeout(s, 100)
                }), e(document).bind("ready", s)
            },
            ...
            suggest: function(t, i, r) {
                ...
                r && e.extend(s, r), s.css.position = "absolute", s.css["z-index"] = 9999, t.attr("autocomplete", "off"), 0 === this._numSuggestionElements && n.bind("resize", function() {
                ...
                return t.data("suggestions", i).valAttr("suggestion-nr", this._numSuggestionElements).unbind("focus.suggest").bind("focus.suggest", function() {
                    ...
                    if (r !== e.formUtils._previousTypedVal) {
                        ...
                        l || 0 === i.length && c.length > 0 ? c.hide() : i.length > 0 && 0 === c.length ? (c = e("<div></div>").css(s.css).appendTo("body"), t.addClass("suggestions-" + u), c.attr("data-suggest-container", u).addClass("jquery-form-suggestions").addClass("jquery-form-suggestion-" + u)) : i.length > 0 && !c.is(":visible") && c.show(), i.length > 0 && r.length !== i[0].length && (o(c, n), c.html(""), e.each(i, function(t, i) {
                    ...
                    if (13 === r && null !== e.formUtils._selectedSuggestion) {
                        if (n = o.valAttr("suggestion-nr"), i = e(".jquery-form-suggestion-" + n), i.length > 0) {
                            ...
                            o.val(l), o.trigger("change"), a(o), t.preventDefault()
                        }
                    } else {
                        ...
                        if (u.length > 0 && e.inArray(r, [38, 40]) > -1) {
                            ...
                            var c = i.innerHeight(),
                                ...
                                h = p * e.formUtils._selectedSuggestion;
                            return (h < d || h > d + c) && i.scrollTop(h), u.removeClass("active-suggestion").css("background", "none").eq(e.formUtils._selectedSuggestion).addClass("active-suggestion").css(s.activeSuggestionCSS), t.preventDefault(), !1
                        }
                    }
        ...
        e.formUtils.addValidator({
            ...
            validatorFunction: function(t) {
                ...
                if (i && r) {
                    if (0 === i.indexOf('"')) {
                        var s = i.length;
                        if (i = i.replace(/\"/g, ""), i.length !== s - 2) return !1
                    }
            ...
            name: "required",
            validatorFunction: function(t, n, i, r, s) {
                switch (n.attr("type")) {
                    case "checkbox":
                        return n.is(":checked");
                    case "radio":
            ...
            validatorFunction: function(t, n, i, r) {
                var s = n.valAttr("length"),
                    o = n.attr("type");
                if (void 0 === s) return alert('Please add attribute "data-validation-length" to ' + n[0].nodeName + " named " + n.attr("name")), !0;
                var a, l = "file" === o && void 0 !== n.get(0).files ? n.get(0).files.length : t.length,
                    u = e.formUtils.numericRangeCheck(l, s);
                switch (u[0]) {
                    case "out":
                        this.errorMessage = r.lengthBadStart + s + r.lengthBadEnd, a = !1;
                        break;
                    case "min":
                        this.errorMessage = r.lengthTooShortStart + u[1] + r.lengthBadEnd, a = !1;
                        break;
                    case "max":
                        this.errorMessage = r.lengthTooLongStart + u[1] + r.lengthBadEnd, a = !1;
                        break;
                    default:
                        a = !0
                }
            ...
            validatorFunction: function(e, t, n) {
                if ("" !== e) {
                    ...
                    if (s.indexOf("number") === -1 && (s += ",number"), s.indexOf("negative") === -1 && 0 === e.indexOf("-")) return !1;
                    if (s.indexOf("range") > -1 && (i = parseFloat(s.substring(s.indexOf("[") + 1, s.indexOf(";"))), r = parseFloat(s.substring(s.indexOf(";") + 1, s.indexOf("]"))), a = !0), "" !== l && (u = !0), "," === o) {
                        if (e.indexOf(".") > -1) return !1;
                        e = e.replace(",", ".")
                    }
                    if ("" === e.replace(/[0-9-]/g, "") && (!a || e >= i && e <= r) && (!u || e % l === 0)) return !0;
                    if (s.indexOf("float") > -1 && null !== e.match(new RegExp("^([0-9-]+)\\.([0-9]+)$")) && (!a || e >= i && e <= r) && (!u || e % l === 0)) return !0
                }
                return !1
            },
            errorMessage: "",
            ...
            validatorFunction: function(t, n, i) {
                var r = n.valAttr("format") || i.dateFormat || "yyyy-mm-dd",
                    s = "false" === n.valAttr("require-leading-zero");
                return e.formUtils.parseDate(t, r, s) !== !1
            },
            errorMessage: "",
            ...
            validatorFunction: function(t, n, i, r, s) {
                var o = !0,
                    a = n.attr("name"),
                    l = e('input[type=checkbox][name^="' + a + '"]', s),
                ...
                var p = e.formUtils.numericRangeCheck(u, c);
                switch (p[0]) {
                    case "out":
                        this.errorMessage = r.groupCheckedRangeStart + c + r.groupCheckedEnd, o = !1;
                        break;
                    case "min":
                        this.errorMessage = r.groupCheckedTooFewStart + p[1] + r.groupCheckedEnd, o = !1;
                        break;
                    case "max":
                        this.errorMessage = r.groupCheckedTooManyStart + p[1] + r.groupCheckedEnd, o = !1;
                        break;
                    default:
                        o = !0
                }
                if (!o) {
                    var h = function() {
                        l.unbind("click", h), l.filter("*[data-validation]").validateInputOnBlur(r, i, !1, "blur")
                    };
                    l.bind("click", h)
                }
                return o
...
function(e) {
    e.fn.hoverIntent = function(t, n, i) {
        ...
        var s, o, a, l, u = function(e) {
                s = e.pageX, o = e.pageY
            },
            c = function(t, n) {
                return n.hoverIntent_t = clearTimeout(n.hoverIntent_t), Math.abs(a - s) + Math.abs(l - o) < r.sensitivity ? (e(n).off("mousemove.hoverIntent", u), n.hoverIntent_s = 1, r.over.apply(n, [t])) : (a = s, l = o, n.hoverIntent_t = setTimeout(function() {
                    c(t, n)
                }, r.interval), void 0)
            },
            d = function(e, t) {
...
function(e) {
    ...
    function i() {
        if (a.length) {
            var i = 0,
                o = e.map(a, function(e) {
                    var t = e.data.selector,
                        n = e.$element;
                    return t ? n.find(t) : n
                });
            for (r = r || t(), s = s || n(); i < a.length; i++)
    ...
    e.event.special.inview = {
        add: function(t) {
            a.push({
                ...
                $element: e(this),
                element: this
            }), !o && a.length && (o = setInterval(i, 250))
        },
        remove: function(e) {
...
function() {
    ...
    function t(e) {
        return "status" === e ? a : y[e] ? y[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "function" != typeof e && "string" != typeof e && e ? void m.error("Method " + e + " does not exist on jQuery.sidr") : y.toggle.apply(this, arguments)
    }
    ...
    function n(e, t) {
        if ("function" == typeof t.source) {
            var n = t.source(name);
            e.html(n)
        } else if ("string" == typeof t.source && l.isUrl(t.source)) w.get(t.source, function(t) {
            e.html(t)
        });
        else if ("string" == typeof t.source) {
            var i = "",
                r = t.source.split(",");
            if (w.each(r, function(e, t) {
                    i += '<div class="sidr-inner">' + w(t).html() + "</div>"
                }), t.renaming) {
                var s = w("<div />").html(i);
    ...
    function i(e) {
        var i = l.transitions,
            ...
            s = r.name,
            o = w("#" + s);
        return 0 === o.length && (o = w("<div />").attr("id", s).appendTo(w("body"))), i.supported && o.css(i.property, r.side + " " + r.speed / 1e3 + "s " + r.timing), o.addClass("sidr").addClass(r.side).data({
            speed: r.speed,
            side: r.side,
            body: r.body,
            displace: r.displace,
            ...
            onOpen: r.onOpen,
            onClose: r.onClose,
            onOpenEnd: r.onOpenEnd,
            onCloseEnd: r.onCloseEnd
        }), o = n(o, r), this.each(function() {
            var e = w(this),
                n = e.data("sidr"),
                i = !1;
            n || (a.moving = !1, a.opened = !1, e.data("sidr", s), e.bind(r.bind, function(e) {
                e.preventDefault(), i || (i = !0, t(r.method, s), setTimeout(function() {
                    i = !1
                }, 100))
            }))
        })
    ...
    var s, o, a = {
        ...
        l = {
            ...
            addPrefix: function(e, t) {
                var n = e.attr(t);
                "string" == typeof n && "" !== n && "sidr-inner" !== n && e.attr(t, n.replace(/([A-Za-z0-9_.\-]+)/g, "sidr-" + t + "-$1"))
            },
            transitions: function() {
                var e = document.body || document.documentElement,
                    ...
                    n = !1,
                    i = "transition";
                return i in t ? n = !0 : ! function() {
                    var e = ["moz", "webkit", "o", "ms"],
                        r = void 0,
                        s = void 0;
                    i = i.charAt(0).toUpperCase() + i.substr(1), n = function() {
                        for (s = 0; s < e.length; s++)
                            if (r = e[s], r + i in t) return !0;
                        return !1
                    }(), i = n ? "-" + r.toLowerCase() + "-" + i.toLowerCase() : null
                }(), {
                    supported: n,
                    property: i
                }
        ...
        f = function() {
            function e(t) {
                r.classCallCheck(this, e), this.name = t, this.item = u("#" + t), this.openClass = "sidr" === t ? "sidr-open" : "sidr-open " + t + "-open", this.menuWidth = this.item.outerWidth(!0), this.speed = this.item.data("speed"), this.side = this.item.data("side"), this.displace = this.item.data("displace"), this.timing = this.item.data("timing"), this.method = this.item.data("method"), this.onOpenCallback = this.item.data("onOpen"), this.onCloseCallback = this.item.data("onClose"), this.onOpenEndCallback = this.item.data("onOpenEnd"), this.onCloseEndCallback = this.item.data("onCloseEnd"), this.body = u(this.item.data("body"))
            }
            return r.createClass(e, [{
                ...
                value: function(e, t) {
                    var n = {},
                        i = this.side;
                    return "open" === e && "body" === t ? n[i] = this.menuWidth + "px" : "close" === e && "menu" === t ? n[i] = "-" + this.menuWidth + "px" : n[i] = 0, n
                }
            }, {
                key: "prepareBody",
                value: function(e) {
                    ...
                    if (this.body.is("body")) {
                        var n = u("html"),
                            i = n.scrollTop();
                        n.css("overflow-x", t).scrollTop(i)
                    }
                }
            }, {
                key: "openBody",
                value: function() {
                    if (this.displace) {
                        ...
                        if (e.supported) t.css(e.property, this.side + " " + this.speed / 1e3 + "s " + this.timing).css(this.side, 0).css({
                            ...
                            var n = this.getAnimation(d, "body");
                            t.css({
                                width: t.width(),
                                position: "absolute"
                            }).animate(n, {
                ...
                value: function() {
                    var e = this;
                    if (this.displace)
                        if (l.transitions.supported) this.body.css(this.side, 0).one(h, function() {
                            e.onCloseBody()
                        });
                        else {
                            var t = this.getAnimation(p, "body");
                            this.body.animate(t, {
                                queue: !1,
                                duration: this.speed,
                                complete: function() {
                ...
                key: "moveBody",
                value: function(e) {
                    e === d ? this.openBody() : this.closeBody()
                }
            }, {
                key: "onOpenMenu",
                value: function(e) {
                    var t = this.name;
                    a.moving = !1, a.opened = t, this.item.unbind(h), this.body.removeClass(c).addClass(this.openClass), this.onOpenEndCallback(), "function" == typeof e && e(t)
                }
            }, {
                key: "openMenu",
                value: function(e) {
                    var t = this,
                        n = this.item;
                    if (l.transitions.supported) n.css(this.side, 0).one(h, function() {
                        t.onOpenMenu(e)
                    });
                    else {
                        var i = this.getAnimation(d, "menu");
                        n.css("display", "block").animate(i, {
                            queue: !1,
                            duration: this.speed,
                            complete: function() {
                                t.onOpenMenu(e)
                ...
                value: function(e) {
                    this.item.css({
                        left: "",
                        right: ""
                    }).unbind(h), u("html").css("overflow-x", ""), a.moving = !1, a.opened = !1, this.body.removeClass(c).removeClass(this.openClass), this.onCloseEndCallback(), "function" == typeof e && e(name)
                }
            }, {
                key: "closeMenu",
                value: function(e) {
                    var t = this,
                        n = this.item;
                    if (l.transitions.supported) n.css(this.side, "").one(h, function() {
                        t.onCloseMenu(e)
                    });
                    else {
                        var i = this.getAnimation(p, "menu");
                        n.animate(i, {
                            queue: !1,
                            duration: this.speed,
                            complete: function() {
                ...
                key: "moveMenu",
                value: function(e, t) {
                    this.body.addClass(c), e === d ? this.openMenu(t) : this.closeMenu(t)
                }
            }, {
                key: "move",
                value: function(e, t) {
        ...
        b = function(t) {
            return function(n, i) {
                "function" == typeof n ? (i = n, n = "sidr") : n || (n = "sidr"), e(t, n, i)
            }
        };
    for (s = 0; s < v.length; s++) o = v[s], y[o] = b(o);
    var w = jQuery;
    jQuery.sidr = t, jQuery.fn.sidr = i
}(),
function(e, t) {
    "use strict";
    var n = function() {
        var n = {
            ...
            g = function(t) {
                ...
                return i.onHandleTouch.call(r) === !1 ? this : void(r.length > 0 && r.is(":hidden") && (n.one("click.superfish", !1), "MSPointerDown" === t.type || "pointerdown" === t.type ? n.trigger("focus") : e.proxy(p, n.parent("li"))()))
            },
            m = function(t, n) {
                var o = "li:has(" + n.popUpSelector + ")";
                e.fn.hoverIntent && !n.disableHI ? t.hoverIntent(p, f, o) : t.on("mouseenter.superfish", o, p).on("mouseleave.superfish", o, f);
                var a = "MSPointerDown.superfish";
                s && (a = "pointerdown.superfish"), i || (a += " touchend.superfish"), r && (a += " mousedown.superfish"), t.on("focusin.superfish", "li", p).on("focusout.superfish", "li", f).on(a, "a", n, g)
            };
        return {
            hide: function(t) {
                if (this.length) {
                    ...
                    var r = i.retainPath === !0 ? i.$path : "",
                        s = n.find("li." + i.hoverClass).add(this).not(r).removeClass(i.hoverClass).children(i.popUpSelector),
                        o = i.speedOut;
                    if (t && (s.show(), o = 0), i.retainPath = !1, i.onBeforeHide.call(s) === !1) return this;
                    s.stop(!0, !0).animate(i.animationOut, o, function() {
                        var t = e(this);
                        i.onHide.call(t)
                    })
                }
            ...
            destroy: function() {
                return this.each(function() {
                    ...
                    }), r.$path.removeClass(r.hoverClass + " " + n.bcClass).addClass(r.pathClass), i.find("." + r.hoverClass).removeClass(r.hoverClass), r.onDestroy.call(i), void i.removeData("sf-options"))
                })
            },
            init: function(t) {
                return this.each(function() {
                    ...
                    var r = e.extend({}, e.fn.superfish.defaults, t),
                        s = i.find(r.popUpSelector).parent("li");
                    r.$path = a(i, r), i.data("sf-options", r), o(i, r), l(s), u(i), m(i, r), s.not("." + n.bcClass).superfish("hide", !0), r.onInit.call(this)
                })
            }
        }
    }();
...
function(e) {
    e.fn.YouTubePopUp = function(t) {
        ...
        e(this).on("click", function(t) {
            ...
            var o = i.split(r)[s],
                a = o.replace(/(&)+(.*)/, "");
            if (i.match(/(youtu.be)/) || i.match(/(youtube.com)/)) var l = "https://www.youtube.com/embed/" + a + "?autoplay=" + n.autoplay;
            if (i.match(/(vimeo.com\/)+[0-9]/) || i.match(/(vimeo.com\/)+[a-zA-Z]/)) var l = "https://player.vimeo.com/video/" + a + "?autoplay=" + n.autoplay;
...
function(e, t, n, i) {
    ...
    r.Defaults = {
        ...
        n ? (e.each(n, function(e) {
            e <= t && e > i && (i = Number(e))
        }), r = e.extend({}, this.options, n[i]), delete r.responsive, r.responsiveClass && this.$element.attr("class", this.$element.attr("class").replace(new RegExp("(" + this.options.responsiveClass + "-)\\S+\\s", "g"), "$1" + i))) : r = e.extend({}, this.options), null !== this.settings && this._breakpoint === i || (this.trigger("change", {
            property: {
                name: "settings",
                value: r
            }
        ...
        return this.settings.freeDrag || e.each(o, e.proxy(function(e, a) {
            return "left" === n && t > a - r && t < a + r ? i = e : "right" === n && t > a - s - r && t < a - s + r ? i = e + 1 : this.op(t, "<", a) && this.op(t, ">", o[e + 1] || a - s) && (i = "left" === n ? e + 1 : e), i === -1
        ...
        if (n.loop) i = this._clones.length / 2 + this._items.length - 1;
            ...
            for (; i - s > 1;) Math.abs(this._coordinates[t = i + s >> 1]) < r ? s = t : i = t;
        ...
        var n = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(r) > o / 2 && (r += s * -1 * o), e = n + r, i = ((e - a) % o + o) % o + a, i !== e && i - r <= l && i - r > 0 && (n = i - r, e = i, this.reset(n))) : this.settings.rewind ? (l += 1, e = (e % l + l) % l) : e = Math.max(a, Math.min(l, e)), this.speed(this.duration(n, e, t)), this.current(e), this.$element.is(":visible") && this.update()
        ...
        this.$stage.empty(), this._items = [], t && (t = t instanceof jQuery ? t : e(t)), this.settings.nestedItemSelector && (t = t.find("." + this.settings.nestedItemSelector)),
            t.filter(function() {
        ...
        n = n === i ? this._items.length : this.normalize(n, !0), t = t instanceof jQuery ? t : e(t), this.trigger("add", {
            content: t,
            position: n
        }), t = this.prepare(t), 0 === this._items.length || n === this._items.length ? (0 === this._items.length && this.$stage.append(t), 0 !== this._items.length && this._items[n - 1].after(t), this._items.push(t), this._mergers.push(1 * t.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1)) : (this._items[n].before(t), this._items.splice(n, 0, t), this._mergers.splice(n, 0, 1 * t.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1)), this._items[r] && this.reset(this._items[r].index()), this.invalidate("items"), this.trigger("added", {
            content: t,
            position: n
        })
...
function(e, t, n, i) {
        ...
        this._core = t, this._loaded = [], this._handlers = {
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": e.proxy(function(t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type))
                    for (var n = this._core.settings, r = n.center && Math.ceil(n.items / 2) || n.items, s = n.center && r * -1 || 0, o = (t.property && t.property.value !== i ? t.property.value : this._core.current()) + s, a = this._core.clones().length, l = e.proxy(function(e, t) {
                            this.load(t)
    ...
    r.Defaults = {
        ...
        !r || e.inArray(i.get(0), this._loaded) > -1 || (r.each(e.proxy(function(n, i) {
            var r, s = e(i),
                o = t.devicePixelRatio > 1 && s.attr("data-src-retina") || s.attr("data-src");
...
function(e, t, n, i) {
    ...
    r.Defaults = {
        ...
        return t.wrap('<div class="owl-video-wrapper"' + o + "></div>"), this._core.settings.lazyLoad && (l = "data-src", u = "owl-lazy"), a.length ? (d(a.attr(l)), a.remove(), !1) : void("youtube" === n.type ? (s = "//img.youtube.com/vi/" + n.id + "/hqdefault.jpg", d(s)) : "vimeo" === n.type ? e.ajax({
            type: "GET",
...
function(e, t) {
    ...
    function e(e) {
        if (null === g) {
            for (var t = e.length, n = 0, i = document.getElementById(s), r = "<ul>"; n < t;) r += "<li>" + e[n] + "</li>", n++;
            r += "</ul>", i.innerHTML = r
        } else g(e)
    }
    ...
    function i(e, t) {
        for (var n = [], i = new RegExp("(^| )" + t + "( |$)"), r = e.getElementsByTagName("*"), s = 0, o = r.length; s < o; s++) i.test(r[s].className) && n.push(r[s]);
        return n
    }
    ...
    var s = "",
        ...
        T = {
            fetch: function(e) {
                if (void 0 === e.maxTweets && (e.maxTweets = 20), void 0 === e.enableLinks && (e.enableLinks = !0), void 0 === e.showUser && (e.showUser = !0), void 0 === e.showTime && (e.showTime = !0), void 0 === e.dateFunction && (e.dateFunction = "default"), void 0 === e.showRetweet && (e.showRetweet = !0), void 0 === e.customCallback && (e.customCallback = null), void 0 === e.showInteraction && (e.showInteraction = !0), void 0 === e.showImages && (e.showImages = !1), void 0 === e.linksInNewWindow && (e.linksInNewWindow = !0), void 0 === e.showPermalinks && (e.showPermalinks = !0), void 0 === e.dataOnly && (e.dataOnly = !1), u) l.push(e);
                else {
                    u = !0, s = e.domId, o = e.maxTweets, a = e.enableLinks, d = e.showUser, c = e.showTime, f = e.showRetweet, p = e.dateFunction, g = e.customCallback, m = e.showInteraction, v = e.showImages, y = e.linksInNewWindow, w = e.showPermalinks, x = e.dataOnly;
                    var t = document.getElementsByTagName("head")[0];
                    null !== C && t.removeChild(C), C = document.createElement("script"), C.type = "text/javascript", void 0 !== e.list ? C.src = "https://syndication.twitter.com/timeline/list?callback=twitterFetcher.callback&dnt=false&list_slug=" + e.list.listSlug + "&screen_name=" + e.list.screenName + "&suppress_response_codes=true&lang=" + (e.lang || b) + "&rnd=" + Math.random() : void 0 !== e.profile ? C.src = "https://syndication.twitter.com/timeline/profile?callback=twitterFetcher.callback&dnt=false&screen_name=" + e.profile.screenName + "&suppress_response_codes=true&lang=" + (e.lang || b) + "&rnd=" + Math.random() : void 0 !== e.likes ? C.src = "https://syndication.twitter.com/timeline/likes?callback=twitterFetcher.callback&dnt=false&screen_name=" + e.likes.screenName + "&suppress_response_codes=true&lang=" + (e.lang || b) + "&rnd=" + Math.random() : C.src = "https://cdn.syndication.twimg.com/widgets/timelines/" + e.id + "?&lang=" + (e.lang || b) + "&callback=twitterFetcher.callback&suppress_response_codes=true&rnd=" + Math.random(), t.appendChild(C)
                }
            },
            callback: function(s) {
                function g(e) {
                ...
                b.innerHTML = s.body, "undefined" == typeof b.getElementsByClassName && (h = !1);
                var C = [],
                    _ = [],
                    S = [],
                    k = [],
                    ...
                    P = 0;
                if (h)
                    for (var D = b.getElementsByClassName("timeline-Tweet"); P < D.length;) D[P].getElementsByClassName("timeline-Tweet-retweetCredit").length > 0 ? E.push(!0) : E.push(!1), (!E[P] || E[P] && f) && (C.push(D[P].getElementsByClassName("timeline-Tweet-text")[0]), A.push(D[P].getAttribute("data-tweet-id")), d && _.push(g(D[P].getElementsByClassName("timeline-Tweet-author")[0])), S.push(D[P].getElementsByClassName("dt-updated")[0]), O.push(D[P].getElementsByClassName("timeline-Tweet-timestamp")[0]), void 0 !== D[P].getElementsByClassName("timeline-Tweet-media")[0] ? k.push(D[P].getElementsByClassName("timeline-Tweet-media")[0]) : k.push(void 0)), P++;
                else
                    for (var D = i(b, "timeline-Tweet"); P < D.length;) i(D[P], "timeline-Tweet-retweetCredit").length > 0 ? E.push(!0) : E.push(!1), (!E[P] || E[P] && f) && (C.push(i(D[P], "timeline-Tweet-text")[0]), A.push(D[P].getAttribute("data-tweet-id")), d && _.push(g(i(D[P], "timeline-Tweet-author")[0])), S.push(i(D[P], "dt-updated")[0]), O.push(i(D[P], "timeline-Tweet-timestamp")[0]), void 0 !== i(D[P], "timeline-Tweet-media")[0] ? k.push(i(D[P], "timeline-Tweet-media")[0]) : k.push(void 0)), P++;
                C.length > o && (C.splice(o, C.length - o), _.splice(o, _.length - o), S.splice(o, S.length - o), E.splice(o, E.length - o), k.splice(o, k.length - o), O.splice(o, O.length - o));
                var F = [],
                    P = C.length,
                    j = 0;
                if (x)
                    for (; j < P;) F.push({
                        tweet: C[j].innerHTML,
                        author: _[j].innerHTML,
                        time: S[j].textContent,
                        image: r(k[j]),
                        rt: E[j],
                        tid: A[j],
                        permalinkURL: void 0 === O[j] ? "" : O[j].href
                    }), j++;
                else
                    for (; j < P;) {
                        if ("string" != typeof p) {
                            var N = S[j].getAttribute("datetime"),
                                M = new Date(S[j].getAttribute("datetime").replace(/-/g, "/").replace("T", " ").split("+")[0]),
                                I = p(M, N);
                            if (S[j].setAttribute("aria-label", I), C[j].textContent)
                                if (h) S[j].textContent = I;
                                else {
                                    var L = document.createElement("p"),
                                        V = document.createTextNode(I);
                                    L.appendChild(V), L.setAttribute("aria-label", I), S[j] = L
                                }
                            else S[j].textContent = I
                        }
                        var $ = "";
                        a ? (y && (n(C[j]), d && n(_[j])), d && ($ += '<div class="user">' + t(_[j].innerHTML) + "</div>"), $ += '<p class="tweet">' + t(C[j].innerHTML) + "</p>", c && ($ += w ? '<p class="timePosted"><a href="' + O[j] + '">' + S[j].getAttribute("aria-label") + "</a></p>" : '<p class="timePosted">' + S[j].getAttribute("aria-label") + "</p>")) : C[j].textContent ? (d && ($ += '<p class="user">' + _[j].textContent + "</p>"), $ += '<p class="tweet">' + C[j].textContent + "</p>", c && ($ += '<p class="timePosted">' + S[j].textContent + "</p>")) : (d && ($ += '<p class="user">' + _[j].textContent + "</p>"), $ += '<p class="tweet">' + C[j].textContent + "</p>", c && ($ += '<p class="timePosted">' + S[j].textContent + "</p>")), m && ($ += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + A[j] + '" class="twitter_reply_icon"' + (y ? ' target="_blank">' : ">") + 'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + A[j] + '" class="twitter_retweet_icon"' + (y ? ' target="_blank">' : ">") + 'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' + A[j] + '" class="twitter_fav_icon"' + (y ? ' target="_blank">' : ">") + "Favorite</a></p>"), v && void 0 !== k[j] && void 0 !== r(k[j]) && ($ += '<div class="media"><img src="' + r(k[j]) + '" alt="Image from tweet" /></div>'), v ? F.push($) : !v && C[j].textContent.length && F.push($), j++
                    }
                e(F), u = !1, l.length > 0 && (T.fetch(l[0]), l.splice(0, 1))
            }
        };
    return window.twitterFetcher = T, T
}),
function(e) {
    ...
    return function(e, t, n, i) {
        ...
        s.RegisterEffect = s.RegisterUI = function(e, t) {
            function n(e, t, n, i) {
                ...
                o.each(e.nodeType ? [e] : e, function(e, t) {
                    i && (n += e * i), r = t.parentNode, o.each(["height", "paddingTop", "paddingBottom", "marginTop", "marginBottom"], function(e, n) {
                        a += parseFloat(s.CSS.getPropertyValue(t, n))
                    })
                }), s.animate(r, {
                    height: ("In" === t ? "+" : "-") + "=" + a
                }, {
            ...
            return s.Redirects[e] = function(r, a, l, u, c, d) {
                function p() {
                    a.display !== i && "none" !== a.display || !/Out$/.test(e) || o.each(c.nodeType ? [c] : c, function(e, t) {
                        s.CSS.setPropertyValue(t, "display", "none")
                    }), a.complete && a.complete.call(c, c), d && d.resolver(c || r)
                }
                var h = l === u - 1;
                ...
                for (var f = 0; f < t.calls.length; f++) {
                    var g = t.calls[f],
                        ...
                        b = g[2] || {},
                        w = {};
                    if (w.duration = v * (y || 1), w.queue = a.queue || "", w.easing = b.easing || "ease", w.delay = parseFloat(b.delay) || 0, w._cacheValues = b._cacheValues || !0, 0 === f) {
                        if (w.delay += parseFloat(a.delay) || 0, 0 === l && (w.begin = function() {
                                a.begin && a.begin.call(c, c);
                                var t = e.match(/(In|Out)$/);
                                t && "In" === t[0] && m.opacity !== i && o.each(c.nodeType ? [c] : c, function(e, t) {
                                    s.CSS.setPropertyValue(t, "opacity", 0)
                                }), a.animateParentHeight && t && n(c, t[0], v + w.delay, a.stagger)
                            }), null !== a.display)
                            if (a.display !== i && "none" !== a.display) w.display = a.display;
                            else if (/In$/.test(e)) {
                            var x = s.CSS.Values.getDisplayType(r);
                    ...
                    f === t.calls.length - 1 && (w.complete = function() {
                        if (t.reset) {
                            for (var e in t.reset) {
                                var n = t.reset[e];
                                s.CSS.Hooks.registered[e] !== i || "string" != typeof n && "number" != typeof n || (t.reset[e] = [t.reset[e], t.reset[e]])
                            }
                            var o = {
                                duration: 0,
                                queue: !1
                            };
                            h && (o.complete = p), s.animate(r, t.reset, o)
                        } else h && p()
                    }, "hidden" === a.visibility && (w.visibility = a.visibility)), s.animate(r, m, w)
                }
            }, s
                ...
                if (i) {
                    ...
                    c[l] = function() {
                        var e = i.e || i.elements,
                            t = e.nodeType ? [e] : e;
                        u && u.call(t, t), s(n)
                    }, i.o ? i.o = o.extend({}, a, c) : i.options = o.extend({}, a, c)
                }
            }), t.reverse()), s(t[0])
        }
    }(window.jQuery || window.Zepto || window, window, document)
...
function(e) {
    ...
    function() {
        var t = e(".js-scroll-to");
        t.each(function() {
            var t = e(this),
                n = t.attr("href"),
                i = t.data("speed") ? t.data("speed") : 1e3;
            "undefined" != typeof n && e(n).length && t.click(function(t) {
                t.preventDefault(), e("html, body").animate({
                    scrollTop: e(n).first().offset().top - e(".js-header").outerHeight()
                }, i)
            })
        })
    }(),
    function() {
        e(".js-accordion").each(function() {
            var t = e(this),
                n = {
            ...
            i.on("click", function(t) {
                t.preventDefault(), e(this).toggleClass("accordion__title--active").parent().find(n.content).slideToggle()
            })
        })
    }(),
    function() {
        e(".js-carousel").each(function() {
            ...
            t.on("initialized.owl.carousel", function() {
                e(this).find(".owl-item.active:first, .owl-item.active:last").addClass("has-fade")
            }).owlCarousel({
                loop: !0,
                responsive: {
                    0: {
                ...
                e(this).find(".has-fade").removeClass("has-fade")
    ...
    function() {
        var t = e(".js-header").first(),
            n = t.find(".js-logo__image"),
            i = function() {
                0 === e(window).scrollTop() ? (t.removeClass("header--fixed"), n.data("switch") === !0 && n.attr("src", "assets/img/common/logo/logo.png")) : (t.addClass("header--fixed"), n.data("switch") === !0 && n.attr("src", "assets/img/common/logo/logo-dark.png"))
            };
        t.length && i(), e(window).scroll(function() {
            i()
        })
    }(),
    function() {
        var t = function() {
            if (e("#map").length) {
                var t = document.getElementById("map"),
                    n = new google.maps.LatLng(e(t).data("lon"), e(t).data("lat")),
                    i = [{
                        featureType: "all",
    ...
    function() {
        e(".js-menu-trigger").sidr({
            side: "right",
            displace: !1
        }), e(".js-mobile-menu__close, #sidr a").on("click", function(t) {
            t.preventDefault(), e.sidr("close", "sidr")
        })
    }(),
    function() {
        ...
        e(window).load(function() {
            ...
            t.each(function() {
                var t = e(this),
                    n = 1e3,
                    i = function(e) {
                        e.find(".owl-item.active .slider__title").velocity("stop").velocity("transition.fadeOut", {
                            duration: n,
                            display: null
                        }), e.find(".owl-item.active img").velocity("stop").velocity("transition.slideDownBigOut", {
                            duration: n,
                            display: null,
                            stagger: 100
                        })
                    ...
                    r = function(t) {
                        var i = [{
                            e: t.find(".owl-item.active .slider__title"),
                            p: "transition.fadeIn",
                            display: null
                        }, {
                            e: t.find(".owl-item.active img.slider__image"),
                            ...
                            e: t.find(".owl-item.active img.slider__secondary"),
                            p: "transition.slideUpBigIn",
                            o: {
                                delay: 150,
                                duration: n,
                        ...
                        t.find(".owl-item.active .slider__title, .owl-item.active img.slider__image, .owl-item.active img.slider__secondary").velocity("stop", !0), e.Velocity.RunSequence(i)
                    };
                t.on("initialized.owl.carousel", function() {
                    r(e(this))
                }), t.owlCarousel({
    ...
    function() {
        var t = e(".js-stats__number");
        t.each(function() {
            var t = e(this),
                n = t.data("number"),
                i = t.data("units") ? t.data("units") : "";
            t.one("inview", function() {
                t.animateNumber({
                    number: n,
                    numberStep: e.animateNumber.numberStepFactories.append(i)
                }, 3e3)
            })
        })
    }(),
    function() {
        e(".js-tabs").each(function() {
            var t = e(this);
            t.easytabs({
                tabActiveClass: "tab__title--active",
                updateHash: !1
            }), t.on("easytabs:before", function() {
                e(this).find(".tabs__content.active img").velocity("stop").velocity("transition.slideDownOut", {
                    duration: 1500,
                    display: null
                })
            }), t.on("easytabs:midTransition", function(e, t, n) {
                n.find("img").velocity("stop").velocity("transition.slideDownIn", {
                    duration: 1500,
                    display: null,
                    stagger: 100
                })
    ...
    function() {
        e(".js-testimonials").each(function() {
            ...
            t.easytabs({
                ...
                e(this).find(".testimonials__quote.active span").velocity("stop").velocity("transition.slideDownOut", {
                    duration: 1e3,
                    display: null
                })
            }), t.on("easytabs:midTransition", function(e, t, n) {
                n.find("span").velocity("stop").velocity("transition.slideDownIn", {
                    duration: 1e3,
                    display: null
                })
            })
    ...
    function() {
        var t = e(".js-twitter-widget").first(),
            n = {
                user: t.data("user"),
                max: t.data("max"),
                lang: t.data("lang")
            ...
            i = function(t) {
                for (var n = 0; n < t.length; n++) e(".js-twitter-widget").first().append(['<div class="twitter-widget__tweet">', '<div class="twitter-widget__content">', '<div class="twitter-widget__user">' + t[n].author + "</div>", t[n].tweet, "</div>", '<div class="twitter-widget__date">— ' + t[n].time + "</div>", "</div>"].join(""));
                e(".js-twitter-widget").first().owlCarousel({
                    items: 1,
                    loop: !0,
